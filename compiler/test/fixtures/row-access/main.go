...
func main() {
	...
	if os.Args[1] == "effects" { rt.WithDatabase(app.MainDatabase,func(){json.NewEncoder(os.Stdout).Encode(app.TestAccessEffects())});return}
 if os.Args[1] == "serve" {app.Main();return}
