...
| 4. DAP and headless debugger | Partial | Go DAP framing, attach/launch, lifecycle, stacks, scopes, variables, source, evaluate, and domain/SQL scopes exist; named-test/headless parity, differential transcripts, and VS Code smoke remain. |
