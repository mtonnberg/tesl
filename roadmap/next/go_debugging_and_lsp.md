...
- 2026-08-20: Expanded the test migration manifest to all 75 Racket-only root rows with concrete owners and replacement forms. All 75 rows are now green against Go/runtime evidence, including OTLP JSON metrics/traces export and outbound traceparent propagation.
