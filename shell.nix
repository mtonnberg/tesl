...
let
  tesl-cli = pkgs.writeShellScriptBin "tesl" ''
    ...
    # Locate the running Tesl runtime collections source dir (contains dsl/ tesl/ lang/).
    ...
    _tesl_init() {
      ...
      local TPL_DIR="$TESL_REPO_ROOT/templates/$TEMPLATE"
    ...
    _tesl_build() {
      ...
      local TPL_DIR="$TESL_REPO_ROOT/templates/docker"
      local DF_SRC
