...
(define/pow
  ...
  #:returns SendEmail
  (thsl-src! "/home/mikael/repos_wsl/tesl-github/tesl/example/queue-api.tesl" 75 (list (cons 'job *job)) (lambda () *job)))

(define/pow
  (listDeadEmails [q : EmailQueue])
  #:capabilities [queueRead]
  #:returns (List DeadJob)
  (thsl-src! "/home/mikael/repos_wsl/tesl-github/tesl/example/queue-api.tesl" 81 (list (cons 'q *q)) (lambda () (raw-value (deadJobs *q)))))

(define/pow
  (replayEmail [job : DeadJob ::: (FromDeadQueue (Id == jobId) job)])
  #:capabilities [queueWrite]
  #:returns Boolean
  (thsl-src! "/home/mikael/repos_wsl/tesl-github/tesl/example/queue-api.tesl" 88 (list (cons 'job *job)) (lambda () (raw-value (requeue *job)))))

(define-handler
  (appRoot)
  #:returns String
  (thsl-src! "/home/mikael/repos_wsl/tesl-github/tesl/example/queue-api.tesl" 92 (list) (lambda () "ok")))
