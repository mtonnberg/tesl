...
(define/pow
  ...
  #:returns Integer
  (thsl-src! "/home/mikael/repos_wsl/tesl-github/tesl/example/sandbox.tesl" 36 (list (cons 'x *x)) (lambda () (tesl-dot/runtime x 'foo3 'Sandbox3.ARecord2))))

(define/pow
  (shouldWork8 [x : Sandbox2.ARecord2])
  #:returns Integer
  (thsl-src! "/home/mikael/repos_wsl/tesl-github/tesl/example/sandbox.tesl" 38 (list (cons 'x *x)) (lambda () (tesl-dot/runtime x 'foo2 'Sandbox2.ARecord2))))
...
(define/pow
  ...
  #:returns Integer
  (thsl-src! "/home/mikael/repos_wsl/tesl-github/tesl/example/sandbox2.tesl" 31 (list (cons 'x *x)) (lambda () *x)))
