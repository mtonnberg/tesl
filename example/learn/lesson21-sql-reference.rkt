...
(module+ test
  ...
  (test-case "findById returns named entity"
    ...
    (check-equal? (thsl-src! "example/learn/lesson21-sql-reference.tesl" 448 (list (cons 'p p)) (lambda () (raw-value (tesl-dot/runtime p 'name 'Product)))) "Widget")
    (check-equal? (thsl-src! "example/learn/lesson21-sql-reference.tesl" 449 (list (cons 'p p)) (lambda () (raw-value (tesl-dot/runtime p 'price 'Product)))) 10)
    (check-equal? (thsl-src! "example/learn/lesson21-sql-reference.tesl" 450 (list (cons 'p p)) (lambda () (raw-value (tesl-dot/runtime p 'category 'Product)))) "tools")
    )
    ))
  )
  ...
  (test-case "setPrice updates the entity and returns it"
    ...
    (check-equal? (thsl-src! "example/learn/lesson21-sql-reference.tesl" 481 (list (cons 'updated updated)) (lambda () (raw-value (tesl-dot/runtime updated 'price 'Product)))) 200)
    (check-equal? (thsl-src! "example/learn/lesson21-sql-reference.tesl" 482 (list (cons 'updated updated)) (lambda () (raw-value (tesl-dot/runtime updated 'category 'Product)))) "recently-updated")
    )
    ))
  )
  ...
  (test-case "updatePriceSilently returns unit"
    ...
    (check-equal? (thsl-src! "example/learn/lesson21-sql-reference.tesl" 489 (list (cons 'found found)) (lambda () (raw-value (tesl-dot/runtime found 'price 'Product)))) 75)
    )
    ))
  )
  ...
  (test-case "upsertProduct inserts when row does not exist"
    ...
    (check-equal? (thsl-src! "example/learn/lesson21-sql-reference.tesl" 541 (list (cons 'found found)) (lambda () (raw-value (tesl-dot/runtime found 'name 'Product)))) "NewProduct")
    (check-equal? (thsl-src! "example/learn/lesson21-sql-reference.tesl" 542 (list (cons 'found found)) (lambda () (raw-value (tesl-dot/runtime found 'price 'Product)))) 42)
    )
    ))
  )
  ...
  (test-case "upsertProduct updates when row already exists"
    ...
    (check-equal? (thsl-src! "example/learn/lesson21-sql-reference.tesl" 549 (list (cons 'found found)) (lambda () (raw-value (tesl-dot/runtime found 'name 'Product)))) "Updated")
    (check-equal? (thsl-src! "example/learn/lesson21-sql-reference.tesl" 550 (list (cons 'found found)) (lambda () (raw-value (tesl-dot/runtime found 'price 'Product)))) 99)
    )
    ))
  )
  ...
  (test-case "createProductWithCategory inserts both atomically"
    ...
    (check-equal? (thsl-src! "example/learn/lesson21-sql-reference.tesl" 598 (list (cons 'p p)) (lambda () (raw-value (tesl-dot/runtime p 'name 'Product)))) "Transactional Widget")
    (check-equal? (thsl-src! "example/learn/lesson21-sql-reference.tesl" 599 (list (cons 'p p)) (lambda () (raw-value (tesl-dot/runtime p 'price 'Product)))) 30)
