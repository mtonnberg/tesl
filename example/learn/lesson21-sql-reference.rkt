...
(module+ test
  ...
  (test-case "findById returns named entity"
    ...
    (define tesl_ignored_1 (thsl-src! "example/learn/lesson21-sql-reference.tesl" 446 (list) (lambda () (createProduct "p1" "Widget" 10 "tools"))))
  ...
  (test-case "findByCategory returns matching rows"
    (with-capabilities (dbRead dbWrite)
    (define tesl_ignored_2 (thsl-src! "example/learn/lesson21-sql-reference.tesl" 454 (list) (lambda () (createProduct "c1" "Hammer" 15 "tools"))))
    (define tesl_ignored_3 (thsl-src! "example/learn/lesson21-sql-reference.tesl" 455 (list) (lambda () (createProduct "c2" "Nail" 2 "tools"))))
    (define tesl_ignored_4 (thsl-src! "example/learn/lesson21-sql-reference.tesl" 456 (list) (lambda () (createProduct "c3" "Book" 20 "media"))))
  ...
  (test-case "findCheapInCategory applies AND condition"
    (with-capabilities (dbRead dbWrite)
    (define tesl_ignored_5 (thsl-src! "example/learn/lesson21-sql-reference.tesl" 462 (list) (lambda () (createProduct "a1" "Cheap Tool" 5 "tools"))))
    (define tesl_ignored_6 (thsl-src! "example/learn/lesson21-sql-reference.tesl" 463 (list) (lambda () (createProduct "a2" "Expensive Tool" 50 "tools"))))
  ...
  (test-case "findFeatured applies OR condition"
    (with-capabilities (dbRead dbWrite)
    (define tesl_ignored_7 (thsl-src! "example/learn/lesson21-sql-reference.tesl" 471 (list) (lambda () (createProduct "f1" "Alpha" 10 "alpha"))))
    (define tesl_ignored_8 (thsl-src! "example/learn/lesson21-sql-reference.tesl" 472 (list) (lambda () (createProduct "f2" "Beta" 10 "beta"))))
    (define tesl_ignored_9 (thsl-src! "example/learn/lesson21-sql-reference.tesl" 473 (list) (lambda () (createProduct "f3" "Gamma" 10 "gamma"))))
  ...
  (test-case "setPrice updates the entity and returns it"
    (with-capabilities (dbRead dbWrite)
    (define tesl_ignored_10 (thsl-src! "example/learn/lesson21-sql-reference.tesl" 479 (list) (lambda () (createProduct "u1" "Updatable" 100 "misc"))))
  ...
  (test-case "updatePriceSilently returns unit"
    (with-capabilities (dbRead dbWrite)
    (define tesl_ignored_11 (thsl-src! "example/learn/lesson21-sql-reference.tesl" 486 (list) (lambda () (createProduct "us1" "Silent" 50 "misc"))))
    (define tesl_ignored_12 (thsl-src! "example/learn/lesson21-sql-reference.tesl" 487 (list) (lambda () (updatePriceSilently "us1" 75))))
  ...
  (test-case "removeProduct deletes a row and returns unit"
    (with-capabilities (dbRead dbWrite)
    (define tesl_ignored_13 (thsl-src! "example/learn/lesson21-sql-reference.tesl" 493 (list) (lambda () (createProduct "d1" "Deletable" 5 "misc"))))
    (define tesl_ignored_14 (thsl-src! "example/learn/lesson21-sql-reference.tesl" 494 (list) (lambda () (removeProduct "d1"))))
  ...
  (test-case "removeProductWithResult returns RowsDeleted when found"
    (with-capabilities (dbRead dbWrite)
    (define tesl_ignored_15 (thsl-src! "example/learn/lesson21-sql-reference.tesl" 505 (list) (lambda () (createProduct "dr1" "ToDelete" 5 "misc"))))
  ...
  (test-case "batchCreate inserts all products"
    (with-capabilities (dbRead dbWrite)
    (define tesl_ignored_16 (thsl-src! "example/learn/lesson21-sql-reference.tesl" 511 (list) (lambda () (batchCreate (list (hash 'id "b1" 'name "Batch1" 'price 10 'category "batch" 'inStock #t) (hash 'id "b2" 'name "Batch2" 'price 20 'category "batch" 'inStock #t))))))
  ...
  (test-case "expensiveProducts filters by price"
    (with-capabilities (dbRead dbWrite)
    (define tesl_ignored_17 (thsl-src! "example/learn/lesson21-sql-reference.tesl" 517 (list) (lambda () (createProduct "e1" "Pricey" 999 "luxury"))))
  ...
  (test-case "findInPriceRange returns only rows in range"
    (with-capabilities (dbRead dbWrite)
    (define tesl_ignored_18 (thsl-src! "example/learn/lesson21-sql-reference.tesl" 523 (list) (lambda () (createProduct "br1" "Cheap" 5 "misc"))))
    (define tesl_ignored_19 (thsl-src! "example/learn/lesson21-sql-reference.tesl" 524 (list) (lambda () (createProduct "br2" "Mid" 25 "misc"))))
    (define tesl_ignored_20 (thsl-src! "example/learn/lesson21-sql-reference.tesl" 525 (list) (lambda () (createProduct "br3" "Expensive" 100 "misc"))))
  ...
  (test-case "findInPriceRangeOrdered returns ordered results"
    (with-capabilities (dbRead dbWrite)
    (define tesl_ignored_21 (thsl-src! "example/learn/lesson21-sql-reference.tesl" 531 (list) (lambda () (createProduct "bro1" "Budget" 15 "misc"))))
    (define tesl_ignored_22 (thsl-src! "example/learn/lesson21-sql-reference.tesl" 532 (list) (lambda () (createProduct "bro2" "Premium" 45 "misc"))))
    (define tesl_ignored_23 (thsl-src! "example/learn/lesson21-sql-reference.tesl" 533 (list) (lambda () (createProduct "bro3" "TooExpensive" 200 "misc"))))
  ...
  (test-case "upsertProduct inserts when row does not exist"
    (with-capabilities (dbRead dbWrite)
    (define tesl_ignored_24 (thsl-src! "example/learn/lesson21-sql-reference.tesl" 539 (list) (lambda () (upsertProduct "up1" "NewProduct" 42))))
  ...
  (test-case "upsertProduct updates when row already exists"
    (with-capabilities (dbRead dbWrite)
    (define tesl_ignored_25 (thsl-src! "example/learn/lesson21-sql-reference.tesl" 546 (list) (lambda () (upsertProduct "up2" "Original" 10))))
    (define tesl_ignored_26 (thsl-src! "example/learn/lesson21-sql-reference.tesl" 547 (list) (lambda () (upsertProduct "up2" "Updated" 99))))
  ...
  (test-case "searchByName with like pattern matches prefix"
    (with-capabilities (dbRead dbWrite)
    (define tesl_ignored_27 (thsl-src! "example/learn/lesson21-sql-reference.tesl" 554 (list) (lambda () (createProduct "lk1" "Widget Pro" 50 "tools"))))
    (define tesl_ignored_28 (thsl-src! "example/learn/lesson21-sql-reference.tesl" 555 (list) (lambda () (createProduct "lk2" "Gadget" 30 "tools"))))
  ...
  (test-case "searchByNameInsensitive with ilike is case-insensitive"
    (with-capabilities (dbRead dbWrite)
    (define tesl_ignored_29 (thsl-src! "example/learn/lesson21-sql-reference.tesl" 561 (list) (lambda () (createProduct "ilk1" "WidgetX" 50 "tools"))))
  ...
  (test-case "countProducts returns total count"
    (with-capabilities (dbRead dbWrite)
    (define tesl_ignored_30 (thsl-src! "example/learn/lesson21-sql-reference.tesl" 567 (list) (lambda () (createProduct "cnt1" "CountMe1" 10 "count-test"))))
    (define tesl_ignored_31 (thsl-src! "example/learn/lesson21-sql-reference.tesl" 568 (list) (lambda () (createProduct "cnt2" "CountMe2" 20 "count-test"))))
  ...
  (test-case "sumPrices returns non-negative sum"
    (with-capabilities (dbRead dbWrite)
    (define tesl_ignored_32 (thsl-src! "example/learn/lesson21-sql-reference.tesl" 574 (list) (lambda () (createProduct "sum1" "SumMe1" 10 "sum-test"))))
    (define tesl_ignored_33 (thsl-src! "example/learn/lesson21-sql-reference.tesl" 575 (list) (lambda () (createProduct "sum2" "SumMe2" 20 "sum-test"))))
  ...
  (test-case "findInStockCheap filters on multiple conditions"
    (with-capabilities (dbRead dbWrite)
    (define tesl_ignored_34 (thsl-src! "example/learn/lesson21-sql-reference.tesl" 581 (list) (lambda () (createProduct "is1" "Cheap In Stock" 5 "misc"))))
    (define tesl_ignored_35 (thsl-src! "example/learn/lesson21-sql-reference.tesl" 582 (list) (lambda () (createProduct "is2" "Expensive In Stock" 500 "misc"))))
  ...
  (test-case "findProductsWithCategory uses innerJoin to filter"
    (with-capabilities (dbRead dbWrite)
    (define tesl_ignored_36 (thsl-src! "example/learn/lesson21-sql-reference.tesl" 588 (list) (lambda () (insert-one! Category (hash 'id "tools" 'label "Tools" 'active #t)))))
    (define tesl_ignored_37 (thsl-src! "example/learn/lesson21-sql-reference.tesl" 589 (list) (lambda () (createProduct "ij1" "Hammer" 15 "tools"))))
    (define tesl_ignored_38 (thsl-src! "example/learn/lesson21-sql-reference.tesl" 591 (list) (lambda () (createProduct "ij2" "Phantom" 10 "nonexistent-cat"))))
  ...
  (test-case "swapStock updates two rows atomically"
    (with-capabilities (dbRead dbWrite)
    (define tesl_ignored_39 (thsl-src! "example/learn/lesson21-sql-reference.tesl" 606 (list) (lambda () (createProduct "swap1" "SwapOut" 10 "misc"))))
    (define tesl_ignored_40 (thsl-src! "example/learn/lesson21-sql-reference.tesl" 607 (list) (lambda () (createProduct "swap2" "SwapIn" 20 "misc"))))
    (define tesl_ignored_41 (thsl-src! "example/learn/lesson21-sql-reference.tesl" 609 (list) (lambda () (swapStock "swap1" "swap2"))))
