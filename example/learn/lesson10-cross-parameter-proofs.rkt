...
(define/pow
  ...
  #:returns Integer
  (thsl-src! "example/learn/lesson10-cross-parameter-proofs.tesl" 52 (list (cons 'rawLo *rawLo) (cons 'rawHi *rawHi) (cons 'value *value)) (lambda () (let/check ([tesl_checked_0 (checkValidRange rawLo rawHi)]) (let ([lo tesl_checked_0]) (raw-value (clampToRange lo rawHi value)))))))
