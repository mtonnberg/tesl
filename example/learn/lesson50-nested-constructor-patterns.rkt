...
(define/pow
  ...
  #:returns String
  (thsl-src! "example/learn/lesson50-nested-constructor-patterns.tesl" 112 (list (cons 'm *m)) (lambda () (let ([tesl_case_5 *m]) (cond [(and (adt-value? *tesl_case_5) (eq? (adt-value-variant *tesl_case_5) 'Nothing)) (raw-value "no result")] [(and (adt-value? *tesl_case_5) (eq? (adt-value-variant *tesl_case_5) 'Something)) (let ([inner (hash-ref (adt-value-fields *tesl_case_5) 'value)]) (let ([tesl_case_6 (raw-value inner)]) (cond [(and (adt-value? *tesl_case_6) (eq? (adt-value-variant *tesl_case_6) 'Success)) (let ([value (hash-ref (adt-value-fields *tesl_case_6) 'value)]) (raw-value (format "success: ~a" (tesl-display-val (tesl_import_String_fromInt *value)))))] [(and (adt-value? *tesl_case_6) (eq? (adt-value-variant *tesl_case_6) 'Failure)) (let ([message (hash-ref (adt-value-fields *tesl_case_6) 'message)]) (raw-value (format "failure: ~a" (tesl-display-val *message))))])))])))))
