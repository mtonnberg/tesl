...
(define/pow
  ...
  #:returns SendNotif
  (thsl-src! "example/learn/lesson28-dead-letter-queue.tesl" 105 (list (cons 'job *job)) (lambda () (reject "notification service unavailable" #:http-code 500))))
...
(define-handler
  (appRoot)
  #:returns String
  (thsl-src! "example/learn/lesson28-dead-letter-queue.tesl" 127 (list) (lambda () "ok")))
