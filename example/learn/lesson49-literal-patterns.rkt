...
(define/pow
  ...
  #:returns String
  (thsl-src! "example/learn/lesson49-literal-patterns.tesl" 39 (list (cons 'n *n)) (lambda () (let ([tesl_case_0 *n]) (cond [(= *tesl_case_0 0) (raw-value "zero")] [(= *tesl_case_0 1) (raw-value "one")] [(= *tesl_case_0 2) (raw-value "two")] [#t (let ([other *tesl_case_0]) (raw-value (format "many (~a)" (tesl-display-val (tesl_import_String_fromInt *other)))))])))))

(define/pow
  (httpStatusText [code : Integer])
  #:returns String
  (thsl-src! "example/learn/lesson49-literal-patterns.tesl" 47 (list (cons 'code *code)) (lambda () (let ([tesl_case_1 *code]) (cond [(= *tesl_case_1 200) (raw-value "OK")] [(= *tesl_case_1 201) (raw-value "Created")] [(= *tesl_case_1 204) (raw-value "No Content")] [(= *tesl_case_1 400) (raw-value "Bad Request")] [(= *tesl_case_1 401) (raw-value "Unauthorized")] [(= *tesl_case_1 403) (raw-value "Forbidden")] [(= *tesl_case_1 404) (raw-value "Not Found")] [(= *tesl_case_1 500) (raw-value "Internal Server Error")] [#t (raw-value "Unknown")])))))

(define/pow
  (parseCommand [cmd : String])
  #:returns String
  (thsl-src! "example/learn/lesson49-literal-patterns.tesl" 64 (list (cons 'cmd *cmd)) (lambda () (let ([tesl_case_2 *cmd]) (cond [(equal? *tesl_case_2 "help") (raw-value "show help")] [(equal? *tesl_case_2 "version") (raw-value "show version")] [(equal? *tesl_case_2 "exit") (raw-value "exit application")] [#t (let ([other *tesl_case_2]) (raw-value (format "unknown command: ~a" (tesl-display-val *other))))])))))

(define/pow
  (classifyChar [c : String])
  #:returns String
  (thsl-src! "example/learn/lesson49-literal-patterns.tesl" 72 (list (cons 'c *c)) (lambda () (let ([tesl_case_3 *c]) (cond [(equal? *tesl_case_3 "a") (raw-value "vowel")] [(equal? *tesl_case_3 "e") (raw-value "vowel")] [(equal? *tesl_case_3 "i") (raw-value "vowel")] [(equal? *tesl_case_3 "o") (raw-value "vowel")] [(equal? *tesl_case_3 "u") (raw-value "vowel")] [#t (raw-value "consonant or other")])))))
