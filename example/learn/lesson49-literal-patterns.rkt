...
(define/pow
  ...
  #:returns String
  (thsl-src-control! "example/learn/lesson49-literal-patterns.tesl" 39 (list (cons 'n *n)) (lambda () (let ([tesl-case-0 *n]) (cond [(= *tesl-case-0 0) (thsl-src! "example/learn/lesson49-literal-patterns.tesl" 40 (list) (lambda () (raw-value "zero")))] [(= *tesl-case-0 1) (thsl-src! "example/learn/lesson49-literal-patterns.tesl" 41 (list) (lambda () (raw-value "one")))] [(= *tesl-case-0 2) (thsl-src! "example/learn/lesson49-literal-patterns.tesl" 42 (list) (lambda () (raw-value "two")))] [#t (let ([other *tesl-case-0]) (thsl-src! "example/learn/lesson49-literal-patterns.tesl" 43 (list (cons 'other other)) (lambda () (raw-value (format "many (~a)" (tesl-display-val (tesl_import_String_fromInt *other)))))))])))))

(define/pow
  (httpStatusText [code : Integer])
  #:returns String
  (thsl-src-control! "example/learn/lesson49-literal-patterns.tesl" 47 (list (cons 'code *code)) (lambda () (let ([tesl-case-1 *code]) (cond [(= *tesl-case-1 200) (thsl-src! "example/learn/lesson49-literal-patterns.tesl" 48 (list) (lambda () (raw-value "OK")))] [(= *tesl-case-1 201) (thsl-src! "example/learn/lesson49-literal-patterns.tesl" 49 (list) (lambda () (raw-value "Created")))] [(= *tesl-case-1 204) (thsl-src! "example/learn/lesson49-literal-patterns.tesl" 50 (list) (lambda () (raw-value "No Content")))] [(= *tesl-case-1 400) (thsl-src! "example/learn/lesson49-literal-patterns.tesl" 51 (list) (lambda () (raw-value "Bad Request")))] [(= *tesl-case-1 401) (thsl-src! "example/learn/lesson49-literal-patterns.tesl" 52 (list) (lambda () (raw-value "Unauthorized")))] [(= *tesl-case-1 403) (thsl-src! "example/learn/lesson49-literal-patterns.tesl" 53 (list) (lambda () (raw-value "Forbidden")))] [(= *tesl-case-1 404) (thsl-src! "example/learn/lesson49-literal-patterns.tesl" 54 (list) (lambda () (raw-value "Not Found")))] [(= *tesl-case-1 500) (thsl-src! "example/learn/lesson49-literal-patterns.tesl" 55 (list) (lambda () (raw-value "Internal Server Error")))] [#t (thsl-src! "example/learn/lesson49-literal-patterns.tesl" 56 (list) (lambda () (raw-value "Unknown")))])))))

(define/pow
  (parseCommand [cmd : String])
  #:returns String
  (thsl-src-control! "example/learn/lesson49-literal-patterns.tesl" 64 (list (cons 'cmd *cmd)) (lambda () (let ([tesl-case-2 *cmd]) (cond [(equal? *tesl-case-2 "help") (thsl-src! "example/learn/lesson49-literal-patterns.tesl" 65 (list) (lambda () (raw-value "show help")))] [(equal? *tesl-case-2 "version") (thsl-src! "example/learn/lesson49-literal-patterns.tesl" 66 (list) (lambda () (raw-value "show version")))] [(equal? *tesl-case-2 "exit") (thsl-src! "example/learn/lesson49-literal-patterns.tesl" 67 (list) (lambda () (raw-value "exit application")))] [#t (let ([other *tesl-case-2]) (thsl-src! "example/learn/lesson49-literal-patterns.tesl" 68 (list (cons 'other other)) (lambda () (raw-value (format "unknown command: ~a" (tesl-display-val *other))))))])))))

(define/pow
  (classifyChar [c : String])
  #:returns String
  (thsl-src-control! "example/learn/lesson49-literal-patterns.tesl" 72 (list (cons 'c *c)) (lambda () (let ([tesl-case-3 *c]) (cond [(equal? *tesl-case-3 "a") (thsl-src! "example/learn/lesson49-literal-patterns.tesl" 73 (list) (lambda () (raw-value "vowel")))] [(equal? *tesl-case-3 "e") (thsl-src! "example/learn/lesson49-literal-patterns.tesl" 74 (list) (lambda () (raw-value "vowel")))] [(equal? *tesl-case-3 "i") (thsl-src! "example/learn/lesson49-literal-patterns.tesl" 75 (list) (lambda () (raw-value "vowel")))] [(equal? *tesl-case-3 "o") (thsl-src! "example/learn/lesson49-literal-patterns.tesl" 76 (list) (lambda () (raw-value "vowel")))] [(equal? *tesl-case-3 "u") (thsl-src! "example/learn/lesson49-literal-patterns.tesl" 77 (list) (lambda () (raw-value "vowel")))] [#t (thsl-src! "example/learn/lesson49-literal-patterns.tesl" 78 (list) (lambda () (raw-value "consonant or other")))])))))
...
(define/pow
  ...
  #:returns Integer
  (thsl-src-control! "example/learn/lesson49-literal-patterns.tesl" 92 (list (cons 'tier *tier) (cons 'promoCode *promoCode)) (lambda () (let ([tesl-case-4 *tier]) (cond [(and (adt-value? *tesl-case-4) (eq? (adt-value-variant *tesl-case-4) 'Enterprise)) (thsl-src! "example/learn/lesson49-literal-patterns.tesl" 93 (list) (lambda () (raw-value 40)))] [(and (adt-value? *tesl-case-4) (eq? (adt-value-variant *tesl-case-4) 'Gold)) (thsl-src! "example/learn/lesson49-literal-patterns.tesl" 94 (list) (lambda () (raw-value 25)))] [(and (adt-value? *tesl-case-4) (eq? (adt-value-variant *tesl-case-4) 'Silver)) (thsl-src! "example/learn/lesson49-literal-patterns.tesl" 95 (list) (lambda () (raw-value 10)))] [(and (adt-value? *tesl-case-4) (eq? (adt-value-variant *tesl-case-4) 'Free)) (thsl-src! "example/learn/lesson49-literal-patterns.tesl" 97 (list) (lambda () (let ([tesl-case-5 *promoCode]) (cond [(equal? *tesl-case-5 "WELCOME10") (thsl-src! "example/learn/lesson49-literal-patterns.tesl" 98 (list) (lambda () (raw-value 10)))] [(equal? *tesl-case-5 "SUMMER20") (thsl-src! "example/learn/lesson49-literal-patterns.tesl" 99 (list) (lambda () (raw-value 20)))] [#t (thsl-src! "example/learn/lesson49-literal-patterns.tesl" 100 (list) (lambda () (raw-value 0)))]))))])))))
