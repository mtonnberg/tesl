...
(define/pow
  ...
  #:returns Integer
  (thsl-src! "example/learn/lesson37-parameterized-adts.tesl" 59 (list (cons 'b *b)) (lambda () (let ([tesl_case_0 *b]) (cond [(and (adt-value? *tesl_case_0) (eq? (adt-value-variant *tesl_case_0) 'MkBox)) (let ([value (hash-ref (adt-value-fields *tesl_case_0) 'value)]) *value)])))))

(define/pow
  (mapBox [b : (Box Integer)] [f : (-> Integer Integer)])
  #:returns (Box Integer)
  (thsl-src! "example/learn/lesson37-parameterized-adts.tesl" 63 (list (cons 'b *b) (cons 'f *f)) (lambda () (let ([tesl_case_1 *b]) (cond [(and (adt-value? *tesl_case_1) (eq? (adt-value-variant *tesl_case_1) 'MkBox)) (let ([value (hash-ref (adt-value-fields *tesl_case_1) 'value)]) (raw-value (raw-value (MkBox (f *value)))))])))))
...
(define/pow
  ...
  #:returns Integer
  (thsl-src! "example/learn/lesson37-parameterized-adts.tesl" 130 (list (cons 'e *e) (cons 'default *default)) (lambda () (let ([tesl_case_7 *e]) (cond [(and (adt-value? *tesl_case_7) (eq? (adt-value-variant *tesl_case_7) 'Left)) *default] [(and (adt-value? *tesl_case_7) (eq? (adt-value-variant *tesl_case_7) 'Right)) (let ([v (hash-ref (adt-value-fields *tesl_case_7) 'value)]) *v)])))))
