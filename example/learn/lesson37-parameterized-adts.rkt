...
(define/pow
  ...
  #:returns (Either String Integer)
  (thsl-src! "example/learn/lesson37-parameterized-adts.tesl" 137 (list (cons 'a *a) (cons 'b *b)) (lambda () (if (tesl-equal? *b 0) (raw-value (raw-value (Left "division by zero"))) (let/check ([tesl-checked-8 (tesl_import_Int_nonZero b)]) (let ([safe tesl-checked-8]) (raw-value (raw-value (Right (tesl_import_Int_divide *a safe))))))))))
...
(define/pow
  ...
  #:returns Integer
  (thsl-src-control! "example/learn/lesson37-parameterized-adts.tesl" 244 (list (cons 'x *x)) (lambda () (let ([tesl-case-13 *x]) (cond [(and (and (adt-value? *tesl-case-13) (eq? (adt-value-variant *tesl-case-13) 'FooLeft)) (let ([v1 (hash-ref (adt-value-fields *tesl-case-13) 'value1)]) (let ([v2 (hash-ref (adt-value-fields *tesl-case-13) 'value2)]) (and (tesl-equal? *v2 "hej") (> *v1 2))))) (let ([v1 (hash-ref (adt-value-fields *tesl-case-13) 'value1)]) (let ([v2 (hash-ref (adt-value-fields *tesl-case-13) 'value2)]) (thsl-src! "example/learn/lesson37-parameterized-adts.tesl" 245 (list (cons 'v1 v1) (cons 'v2 v2)) (lambda () (raw-value 5)))))] [(and (adt-value? *tesl-case-13) (eq? (adt-value-variant *tesl-case-13) 'FooLeft)) (let ([v1 (hash-ref (adt-value-fields *tesl-case-13) 'value1)]) (thsl-src! "example/learn/lesson37-parameterized-adts.tesl" 246 (list (cons 'v1 v1)) (lambda () *v1)))] [(and (and (adt-value? *tesl-case-13) (eq? (adt-value-variant *tesl-case-13) 'FooRight)) (let ([b (hash-ref (adt-value-fields *tesl-case-13) 'value)]) (tesl-equal? *b "hej"))) (let ([b (hash-ref (adt-value-fields *tesl-case-13) 'value)]) (thsl-src! "example/learn/lesson37-parameterized-adts.tesl" 247 (list (cons 'b b)) (lambda () (raw-value 5))))] [(and (adt-value? *tesl-case-13) (eq? (adt-value-variant *tesl-case-13) 'FooRight)) (thsl-src! "example/learn/lesson37-parameterized-adts.tesl" 248 (list) (lambda () (raw-value 2)))])))))
