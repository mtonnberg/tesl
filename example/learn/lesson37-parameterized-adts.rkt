...
(define/pow
  ...
  #:returns Integer
  (thsl-src! "example/learn/lesson37-parameterized-adts.tesl" 59 (list (cons 'b *b)) (lambda () (let ([tesl_case_0 *b]) (cond [(and (adt-value? *tesl_case_0) (eq? (adt-value-variant *tesl_case_0) 'MkBox)) (let ([value (hash-ref (adt-value-fields *tesl_case_0) 'value)]) (thsl-src! "example/learn/lesson37-parameterized-adts.tesl" 60 (list (cons 'value value)) (lambda () *value)))])))))

(define/pow
  (mapBox [b : (Box Integer)] [f : (-> Integer Integer)])
  #:returns (Box Integer)
  (thsl-src! "example/learn/lesson37-parameterized-adts.tesl" 63 (list (cons 'b *b) (cons 'f *f)) (lambda () (let ([tesl_case_1 *b]) (cond [(and (adt-value? *tesl_case_1) (eq? (adt-value-variant *tesl_case_1) 'MkBox)) (let ([value (hash-ref (adt-value-fields *tesl_case_1) 'value)]) (thsl-src! "example/learn/lesson37-parameterized-adts.tesl" 64 (list (cons 'value value)) (lambda () (raw-value (raw-value (MkBox (f *value)))))))])))))
...
(define/pow
  ...
  #:returns Integer
  (thsl-src! "example/learn/lesson37-parameterized-adts.tesl" 85 (list (cons 'o *o) (cons 'default *default)) (lambda () (let ([tesl_case_2 *o]) (cond [(and (adt-value? *tesl_case_2) (eq? (adt-value-variant *tesl_case_2) 'Some)) (let ([value (hash-ref (adt-value-fields *tesl_case_2) 'value)]) (thsl-src! "example/learn/lesson37-parameterized-adts.tesl" 86 (list (cons 'value value)) (lambda () *value)))] [(and (adt-value? *tesl_case_2) (eq? (adt-value-variant *tesl_case_2) 'None)) (thsl-src! "example/learn/lesson37-parameterized-adts.tesl" 87 (list) (lambda () *default))])))))

(define/pow
  (mapOption [o : (Option Integer)] [f : (-> Integer Integer)])
  #:returns (Option Integer)
  (thsl-src! "example/learn/lesson37-parameterized-adts.tesl" 90 (list (cons 'o *o) (cons 'f *f)) (lambda () (let ([tesl_case_3 *o]) (cond [(and (adt-value? *tesl_case_3) (eq? (adt-value-variant *tesl_case_3) 'Some)) (let ([value (hash-ref (adt-value-fields *tesl_case_3) 'value)]) (thsl-src! "example/learn/lesson37-parameterized-adts.tesl" 91 (list (cons 'value value)) (lambda () (raw-value (raw-value (Some (f *value)))))))] [(and (adt-value? *tesl_case_3) (eq? (adt-value-variant *tesl_case_3) 'None)) (thsl-src! "example/learn/lesson37-parameterized-adts.tesl" 92 (list) (lambda () (raw-value None)))])))))

(define/pow
  (bindOption [o : (Option Integer)] [f : (-> Integer (Option Integer))])
  #:returns (Option Integer)
  (thsl-src! "example/learn/lesson37-parameterized-adts.tesl" 95 (list (cons 'o *o) (cons 'f *f)) (lambda () (let ([tesl_case_4 *o]) (cond [(and (adt-value? *tesl_case_4) (eq? (adt-value-variant *tesl_case_4) 'Some)) (let ([value (hash-ref (adt-value-fields *tesl_case_4) 'value)]) (thsl-src! "example/learn/lesson37-parameterized-adts.tesl" 96 (list (cons 'value value)) (lambda () (raw-value (f *value)))))] [(and (adt-value? *tesl_case_4) (eq? (adt-value-variant *tesl_case_4) 'None)) (thsl-src! "example/learn/lesson37-parameterized-adts.tesl" 97 (list) (lambda () (raw-value None)))])))))
...
(define/pow
  ...
  (thsl-src! "example/learn/lesson37-parameterized-adts.tesl" 120 (list (cons 'e *e) (cons 'f *f)) (lambda () (let ([tesl_case_5 *e]) (cond [(and (adt-value? *tesl_case_5) (eq? (adt-value-variant *tesl_case_5) 'Left)) (let ([value (hash-ref (adt-value-fields *tesl_case_5) 'value)]) (thsl-src! "example/learn/lesson37-parameterized-adts.tesl" 121 (list (cons 'value value)) (lambda () (raw-value (raw-value (Left *value))))))] [(and (adt-value? *tesl_case_5) (eq? (adt-value-variant *tesl_case_5) 'Right)) (let ([value (hash-ref (adt-value-fields *tesl_case_5) 'value)]) (thsl-src! "example/learn/lesson37-parameterized-adts.tesl" 122 (list (cons 'value value)) (lambda () (raw-value (raw-value (Right (f *value)))))))])))))

(define/pow
  (mapLeft [e : (Either String Integer)] [f : (-> String String)])
  #:returns (Either String Integer)
  (thsl-src! "example/learn/lesson37-parameterized-adts.tesl" 125 (list (cons 'e *e) (cons 'f *f)) (lambda () (let ([tesl_case_6 *e]) (cond [(and (adt-value? *tesl_case_6) (eq? (adt-value-variant *tesl_case_6) 'Left)) (let ([value (hash-ref (adt-value-fields *tesl_case_6) 'value)]) (thsl-src! "example/learn/lesson37-parameterized-adts.tesl" 126 (list (cons 'value value)) (lambda () (raw-value (raw-value (Left (f *value)))))))] [(and (adt-value? *tesl_case_6) (eq? (adt-value-variant *tesl_case_6) 'Right)) (let ([value (hash-ref (adt-value-fields *tesl_case_6) 'value)]) (thsl-src! "example/learn/lesson37-parameterized-adts.tesl" 127 (list (cons 'value value)) (lambda () (raw-value (raw-value (Right *value))))))])))))

(define/pow
  (fromRight [e : (Either String Integer)] [default : Integer])
  #:returns Integer
  (thsl-src! "example/learn/lesson37-parameterized-adts.tesl" 130 (list (cons 'e *e) (cons 'default *default)) (lambda () (let ([tesl_case_7 *e]) (cond [(and (adt-value? *tesl_case_7) (eq? (adt-value-variant *tesl_case_7) 'Left)) (thsl-src! "example/learn/lesson37-parameterized-adts.tesl" 131 (list) (lambda () *default))] [(and (adt-value? *tesl_case_7) (eq? (adt-value-variant *tesl_case_7) 'Right)) (let ([v (hash-ref (adt-value-fields *tesl_case_7) 'value)]) (thsl-src! "example/learn/lesson37-parameterized-adts.tesl" 132 (list (cons 'v v)) (lambda () *v)))])))))

(define/pow
  (safeDivide [a : Integer] [b : Integer])
  #:returns (Either String Integer)
  (thsl-src! "example/learn/lesson37-parameterized-adts.tesl" 137 (list (cons 'a *a) (cons 'b *b)) (lambda () (if (equal? *b 0) (raw-value (raw-value (Left "division by zero"))) (let/check ([tesl_checked_8 (tesl_import_Int_nonZero b)]) (let ([safe tesl_checked_8]) (raw-value (raw-value (Right (tesl_import_Int_divide *a safe))))))))))
...
(define/pow
  ...
  #:returns Integer
  (thsl-src! "example/learn/lesson37-parameterized-adts.tesl" 175 (list (cons 't *t)) (lambda () (let ([tesl_case_9 *t]) (cond [(and (adt-value? *tesl_case_9) (eq? (adt-value-variant *tesl_case_9) 'Leaf)) (thsl-src! "example/learn/lesson37-parameterized-adts.tesl" 176 (list) (lambda () (raw-value 0)))] [(and (adt-value? *tesl_case_9) (eq? (adt-value-variant *tesl_case_9) 'Node)) (let ([left (hash-ref (adt-value-fields *tesl_case_9) 'left)]) (let ([value (hash-ref (adt-value-fields *tesl_case_9) 'value)]) (let ([right (hash-ref (adt-value-fields *tesl_case_9) 'right)]) (thsl-src! "example/learn/lesson37-parameterized-adts.tesl" 178 (list (cons 'left left) (cons 'value value) (cons 'right right)) (lambda () (raw-value (+ (+ 1 (raw-value (treeSize *left))) (raw-value (treeSize *right)))))))))])))))

(define/pow
  (treeDepth [t : (Tree Integer)])
  #:returns Integer
  (thsl-src! "example/learn/lesson37-parameterized-adts.tesl" 181 (list (cons 't *t)) (lambda () (let ([tesl_case_10 *t]) (cond [(and (adt-value? *tesl_case_10) (eq? (adt-value-variant *tesl_case_10) 'Leaf)) (thsl-src! "example/learn/lesson37-parameterized-adts.tesl" 182 (list) (lambda () (raw-value 0)))] [(and (adt-value? *tesl_case_10) (eq? (adt-value-variant *tesl_case_10) 'Node)) (let ([left (hash-ref (adt-value-fields *tesl_case_10) 'left)]) (let ([value (hash-ref (adt-value-fields *tesl_case_10) 'value)]) (let ([right (hash-ref (adt-value-fields *tesl_case_10) 'right)]) (thsl-src! "example/learn/lesson37-parameterized-adts.tesl" 184 (list (cons 'left left) (cons 'value value) (cons 'right right)) (lambda () (let ([ld (treeDepth *left)]) (let ([rd (treeDepth *right)]) (let ([maxD (if (> (raw-value ld) (raw-value rd)) ld rd)]) (raw-value (+ 1 (raw-value maxD)))))))))))])))))

(define/pow
  (treeContains [t : (Tree Integer)] [target : Integer])
  #:returns Boolean
  (thsl-src! "example/learn/lesson37-parameterized-adts.tesl" 193 (list (cons 't *t) (cons 'target *target)) (lambda () (let ([tesl_case_11 *t]) (cond [(and (adt-value? *tesl_case_11) (eq? (adt-value-variant *tesl_case_11) 'Leaf)) (thsl-src! "example/learn/lesson37-parameterized-adts.tesl" 194 (list) (lambda () (raw-value #f)))] [(and (adt-value? *tesl_case_11) (eq? (adt-value-variant *tesl_case_11) 'Node)) (let ([left (hash-ref (adt-value-fields *tesl_case_11) 'left)]) (let ([value (hash-ref (adt-value-fields *tesl_case_11) 'value)]) (let ([right (hash-ref (adt-value-fields *tesl_case_11) 'right)]) (thsl-src! "example/learn/lesson37-parameterized-adts.tesl" 196 (list (cons 'left left) (cons 'value value) (cons 'right right)) (lambda () (if (equal? *value *target) (raw-value #t) (if (< *target *value) (raw-value (treeContains *left target)) (raw-value (treeContains *right target)))))))))])))))

(define/pow
  (treeInsert [t : (Tree Integer)] [v : Integer])
  #:returns (Tree Integer)
  (thsl-src! "example/learn/lesson37-parameterized-adts.tesl" 204 (list (cons 't *t) (cons 'v *v)) (lambda () (let ([tesl_case_12 *t]) (cond [(and (adt-value? *tesl_case_12) (eq? (adt-value-variant *tesl_case_12) 'Leaf)) (thsl-src! "example/learn/lesson37-parameterized-adts.tesl" 205 (list) (lambda () (raw-value (raw-value (Node Leaf *v Leaf)))))] [(and (adt-value? *tesl_case_12) (eq? (adt-value-variant *tesl_case_12) 'Node)) (let ([left (hash-ref (adt-value-fields *tesl_case_12) 'left)]) (let ([value (hash-ref (adt-value-fields *tesl_case_12) 'value)]) (let ([right (hash-ref (adt-value-fields *tesl_case_12) 'right)]) (thsl-src! "example/learn/lesson37-parameterized-adts.tesl" 207 (list (cons 'left left) (cons 'value value) (cons 'right right)) (lambda () (if (equal? *v *value) *t (if (< *v *value) (raw-value (raw-value (Node (treeInsert *left v) *value *right))) (raw-value (raw-value (Node *left *value (treeInsert *right v)))))))))))])))))
...
(define/pow
  ...
  #:returns Integer
  (thsl-src! "example/learn/lesson37-parameterized-adts.tesl" 244 (list (cons 'x *x)) (lambda () (let ([tesl_case_13 *x]) (cond [(and (and (adt-value? *tesl_case_13) (eq? (adt-value-variant *tesl_case_13) 'FooLeft)) (let ([v1 (hash-ref (adt-value-fields *tesl_case_13) 'value1)]) (let ([v2 (hash-ref (adt-value-fields *tesl_case_13) 'value2)]) (and (equal? *v2 "hej") (> *v1 2))))) (let ([v1 (hash-ref (adt-value-fields *tesl_case_13) 'value1)]) (let ([v2 (hash-ref (adt-value-fields *tesl_case_13) 'value2)]) (thsl-src! "example/learn/lesson37-parameterized-adts.tesl" 245 (list (cons 'v1 v1) (cons 'v2 v2)) (lambda () (raw-value 5)))))] [(and (adt-value? *tesl_case_13) (eq? (adt-value-variant *tesl_case_13) 'FooLeft)) (let ([v1 (hash-ref (adt-value-fields *tesl_case_13) 'value1)]) (thsl-src! "example/learn/lesson37-parameterized-adts.tesl" 246 (list (cons 'v1 v1)) (lambda () *v1)))] [(and (and (adt-value? *tesl_case_13) (eq? (adt-value-variant *tesl_case_13) 'FooRight)) (let ([b (hash-ref (adt-value-fields *tesl_case_13) 'value)]) (equal? *b "hej"))) (let ([b (hash-ref (adt-value-fields *tesl_case_13) 'value)]) (thsl-src! "example/learn/lesson37-parameterized-adts.tesl" 247 (list (cons 'b b)) (lambda () (raw-value 5))))] [(and (adt-value? *tesl_case_13) (eq? (adt-value-variant *tesl_case_13) 'FooRight)) (thsl-src! "example/learn/lesson37-parameterized-adts.tesl" 248 (list) (lambda () (raw-value 2)))])))))
