...
(define/pow
  ...
  #:returns Integer
  (thsl-src! "example/learn/lesson35-list-decomposition.tesl" 75 (list (cons 'xs *xs) (cons 'default *default)) (lambda () (let ([tesl_case_0 (raw-value (tesl_import_List_head *xs))]) (cond [(and (adt-value? *tesl_case_0) (eq? (adt-value-variant *tesl_case_0) 'Nothing)) (thsl-src! "example/learn/lesson35-list-decomposition.tesl" 76 (list) (lambda () *default))] [(and (adt-value? *tesl_case_0) (eq? (adt-value-variant *tesl_case_0) 'Something)) (let ([h (hash-ref (adt-value-fields *tesl_case_0) 'value)]) (thsl-src! "example/learn/lesson35-list-decomposition.tesl" 77 (list (cons 'h h)) (lambda () *h)))])))))
...
(define/pow
  ...
  #:returns (Maybe Integer)
  (thsl-src! "example/learn/lesson35-list-decomposition.tesl" 202 (list (cons 'xs *xs) (cons 'ys *ys)) (lambda () (let ([tesl_case_2 (raw-value (tesl_import_List_head *xs))]) (cond [(and (adt-value? *tesl_case_2) (eq? (adt-value-variant *tesl_case_2) 'Nothing)) (thsl-src! "example/learn/lesson35-list-decomposition.tesl" 203 (list) (lambda () (raw-value Nothing)))] [(and (adt-value? *tesl_case_2) (eq? (adt-value-variant *tesl_case_2) 'Something)) (let ([hx (hash-ref (adt-value-fields *tesl_case_2) 'value)]) (thsl-src! "example/learn/lesson35-list-decomposition.tesl" 205 (list (cons 'hx hx)) (lambda () (let ([tesl_case_3 (raw-value (tesl_import_List_head *ys))]) (cond [(and (adt-value? *tesl_case_3) (eq? (adt-value-variant *tesl_case_3) 'Nothing)) (thsl-src! "example/learn/lesson35-list-decomposition.tesl" 206 (list) (lambda () (raw-value Nothing)))] [(and (adt-value? *tesl_case_3) (eq? (adt-value-variant *tesl_case_3) 'Something)) (let ([hy (hash-ref (adt-value-fields *tesl_case_3) 'value)]) (thsl-src! "example/learn/lesson35-list-decomposition.tesl" 207 (list (cons 'hy hy)) (lambda () (raw-value (raw-value (Something (+ *hx *hy)))))))])))))])))))
