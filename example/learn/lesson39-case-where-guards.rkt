...
(define/pow
  ...
  #:returns String
  (thsl-src! "example/learn/lesson39-case-where-guards.tesl" 56 (list (cons 's *s)) (lambda () (let ([tesl_case_0 *s]) (cond [(and (and (adt-value? *tesl_case_0) (eq? (adt-value-variant *tesl_case_0) 'Circle)) (let ([r (hash-ref (adt-value-fields *tesl_case_0) 'radius)]) (> *r 50))) (let ([r (hash-ref (adt-value-fields *tesl_case_0) 'radius)]) (thsl-src! "example/learn/lesson39-case-where-guards.tesl" 57 (list (cons 'r r)) (lambda () (raw-value "huge circle"))))] [(and (and (adt-value? *tesl_case_0) (eq? (adt-value-variant *tesl_case_0) 'Circle)) (let ([r (hash-ref (adt-value-fields *tesl_case_0) 'radius)]) (> *r 20))) (let ([r (hash-ref (adt-value-fields *tesl_case_0) 'radius)]) (thsl-src! "example/learn/lesson39-case-where-guards.tesl" 58 (list (cons 'r r)) (lambda () (raw-value "large circle"))))] [(and (and (adt-value? *tesl_case_0) (eq? (adt-value-variant *tesl_case_0) 'Circle)) (let ([r (hash-ref (adt-value-fields *tesl_case_0) 'radius)]) (> *r 5))) (let ([r (hash-ref (adt-value-fields *tesl_case_0) 'radius)]) (thsl-src! "example/learn/lesson39-case-where-guards.tesl" 59 (list (cons 'r r)) (lambda () (raw-value "medium circle"))))] [(and (adt-value? *tesl_case_0) (eq? (adt-value-variant *tesl_case_0) 'Circle)) (thsl-src! "example/learn/lesson39-case-where-guards.tesl" 60 (list) (lambda () (raw-value "small circle")))] [(and (and (adt-value? *tesl_case_0) (eq? (adt-value-variant *tesl_case_0) 'Rectangle)) (let ([w (hash-ref (adt-value-fields *tesl_case_0) 'width)]) (let ([h (hash-ref (adt-value-fields *tesl_case_0) 'height)]) (equal? *w *h)))) (let ([w (hash-ref (adt-value-fields *tesl_case_0) 'width)]) (let ([h (hash-ref (adt-value-fields *tesl_case_0) 'height)]) (thsl-src! "example/learn/lesson39-case-where-guards.tesl" 61 (list (cons 'w w) (cons 'h h)) (lambda () (raw-value "square")))))] [(and (and (adt-value? *tesl_case_0) (eq? (adt-value-variant *tesl_case_0) 'Rectangle)) (let ([w (hash-ref (adt-value-fields *tesl_case_0) 'width)]) (let ([h (hash-ref (adt-value-fields *tesl_case_0) 'height)]) (and (> *w 30) (> *h 30))))) (let ([w (hash-ref (adt-value-fields *tesl_case_0) 'width)]) (let ([h (hash-ref (adt-value-fields *tesl_case_0) 'height)]) (thsl-src! "example/learn/lesson39-case-where-guards.tesl" 62 (list (cons 'w w) (cons 'h h)) (lambda () (raw-value "large rectangle")))))] [(and (adt-value? *tesl_case_0) (eq? (adt-value-variant *tesl_case_0) 'Rectangle)) (thsl-src! "example/learn/lesson39-case-where-guards.tesl" 63 (list) (lambda () (raw-value "small rectangle")))] [(and (adt-value? *tesl_case_0) (eq? (adt-value-variant *tesl_case_0) 'Triangle)) (thsl-src! "example/learn/lesson39-case-where-guards.tesl" 64 (list) (lambda () (raw-value "triangle")))])))))

(define/pow
  (describeShape [s : Shape])
  #:returns String
  (thsl-src! "example/learn/lesson39-case-where-guards.tesl" 68 (list (cons 's *s)) (lambda () (let ([tesl_case_1 *s]) (cond [(and (and (adt-value? *tesl_case_1) (eq? (adt-value-variant *tesl_case_1) 'Circle)) (let ([r (hash-ref (adt-value-fields *tesl_case_1) 'radius)]) (equal? *r 0))) (let ([r (hash-ref (adt-value-fields *tesl_case_1) 'radius)]) (thsl-src! "example/learn/lesson39-case-where-guards.tesl" 69 (list (cons 'r r)) (lambda () (raw-value "degenerate circle (point)"))))] [(and (and (adt-value? *tesl_case_1) (eq? (adt-value-variant *tesl_case_1) 'Circle)) (let ([r (hash-ref (adt-value-fields *tesl_case_1) 'radius)]) (> *r 100))) (let ([r (hash-ref (adt-value-fields *tesl_case_1) 'radius)]) (thsl-src! "example/learn/lesson39-case-where-guards.tesl" 70 (list (cons 'r r)) (lambda () (raw-value (format "enormous circle (r=~a)" (tesl-display-val *r))))))] [(and (adt-value? *tesl_case_1) (eq? (adt-value-variant *tesl_case_1) 'Circle)) (let ([r (hash-ref (adt-value-fields *tesl_case_1) 'radius)]) (thsl-src! "example/learn/lesson39-case-where-guards.tesl" 71 (list (cons 'r r)) (lambda () (raw-value (format "circle with radius ~a" (tesl-display-val *r))))))] [(and (and (adt-value? *tesl_case_1) (eq? (adt-value-variant *tesl_case_1) 'Rectangle)) (let ([w (hash-ref (adt-value-fields *tesl_case_1) 'width)]) (let ([h (hash-ref (adt-value-fields *tesl_case_1) 'height)]) (equal? *w *h)))) (let ([w (hash-ref (adt-value-fields *tesl_case_1) 'width)]) (let ([h (hash-ref (adt-value-fields *tesl_case_1) 'height)]) (thsl-src! "example/learn/lesson39-case-where-guards.tesl" 72 (list (cons 'w w) (cons 'h h)) (lambda () (raw-value (format "square with side ~a" (tesl-display-val *w)))))))] [(and (adt-value? *tesl_case_1) (eq? (adt-value-variant *tesl_case_1) 'Rectangle)) (let ([w (hash-ref (adt-value-fields *tesl_case_1) 'width)]) (let ([h (hash-ref (adt-value-fields *tesl_case_1) 'height)]) (thsl-src! "example/learn/lesson39-case-where-guards.tesl" 73 (list (cons 'w w) (cons 'h h)) (lambda () (raw-value (format "rectangle ~ax~a" (tesl-display-val *w) (tesl-display-val *h)))))))] [(and (and (adt-value? *tesl_case_1) (eq? (adt-value-variant *tesl_case_1) 'Triangle)) (let ([b (hash-ref (adt-value-fields *tesl_case_1) 'base)]) (let ([h (hash-ref (adt-value-fields *tesl_case_1) 'height)]) (equal? *b *h)))) (let ([b (hash-ref (adt-value-fields *tesl_case_1) 'base)]) (let ([h (hash-ref (adt-value-fields *tesl_case_1) 'height)]) (thsl-src! "example/learn/lesson39-case-where-guards.tesl" 74 (list (cons 'b b) (cons 'h h)) (lambda () (raw-value "isosceles triangle")))))] [(and (adt-value? *tesl_case_1) (eq? (adt-value-variant *tesl_case_1) 'Triangle)) (thsl-src! "example/learn/lesson39-case-where-guards.tesl" 75 (list) (lambda () (raw-value "triangle")))])))))
...
(define/pow
  ...
  #:returns String
  (thsl-src! "example/learn/lesson39-case-where-guards.tesl" 88 (list (cons 'p *p)) (lambda () (let ([tesl_case_2 *p]) (cond [(and (and (adt-value? *tesl_case_2) (eq? (adt-value-variant *tesl_case_2) 'Task)) (let ([label (hash-ref (adt-value-fields *tesl_case_2) 'label)]) (let ([urgency (hash-ref (adt-value-fields *tesl_case_2) 'urgency)]) (and (equal? *label "critical") (> *urgency 8))))) (let ([label (hash-ref (adt-value-fields *tesl_case_2) 'label)]) (let ([urgency (hash-ref (adt-value-fields *tesl_case_2) 'urgency)]) (thsl-src! "example/learn/lesson39-case-where-guards.tesl" 89 (list (cons 'label label) (cons 'urgency urgency)) (lambda () (raw-value "drop-everything")))))] [(and (and (adt-value? *tesl_case_2) (eq? (adt-value-variant *tesl_case_2) 'Task)) (let ([label (hash-ref (adt-value-fields *tesl_case_2) 'label)]) (let ([urgency (hash-ref (adt-value-fields *tesl_case_2) 'urgency)]) (> *urgency 8)))) (let ([label (hash-ref (adt-value-fields *tesl_case_2) 'label)]) (let ([urgency (hash-ref (adt-value-fields *tesl_case_2) 'urgency)]) (thsl-src! "example/learn/lesson39-case-where-guards.tesl" 90 (list (cons 'label label) (cons 'urgency urgency)) (lambda () (raw-value "urgent")))))] [(and (and (adt-value? *tesl_case_2) (eq? (adt-value-variant *tesl_case_2) 'Task)) (let ([label (hash-ref (adt-value-fields *tesl_case_2) 'label)]) (let ([urgency (hash-ref (adt-value-fields *tesl_case_2) 'urgency)]) (> *urgency 4)))) (let ([label (hash-ref (adt-value-fields *tesl_case_2) 'label)]) (let ([urgency (hash-ref (adt-value-fields *tesl_case_2) 'urgency)]) (thsl-src! "example/learn/lesson39-case-where-guards.tesl" 91 (list (cons 'label label) (cons 'urgency urgency)) (lambda () (raw-value "normal")))))] [(and (adt-value? *tesl_case_2) (eq? (adt-value-variant *tesl_case_2) 'Task)) (thsl-src! "example/learn/lesson39-case-where-guards.tesl" 92 (list) (lambda () (raw-value "low")))] [(and (and (adt-value? *tesl_case_2) (eq? (adt-value-variant *tesl_case_2) 'Deadline)) (let ([label (hash-ref (adt-value-fields *tesl_case_2) 'label)]) (let ([days (hash-ref (adt-value-fields *tesl_case_2) 'days)]) (equal? *days 0)))) (let ([label (hash-ref (adt-value-fields *tesl_case_2) 'label)]) (let ([days (hash-ref (adt-value-fields *tesl_case_2) 'days)]) (thsl-src! "example/learn/lesson39-case-where-guards.tesl" 93 (list (cons 'label label) (cons 'days days)) (lambda () (raw-value "due today")))))] [(and (and (adt-value? *tesl_case_2) (eq? (adt-value-variant *tesl_case_2) 'Deadline)) (let ([label (hash-ref (adt-value-fields *tesl_case_2) 'label)]) (let ([days (hash-ref (adt-value-fields *tesl_case_2) 'days)]) (< *days 0)))) (let ([label (hash-ref (adt-value-fields *tesl_case_2) 'label)]) (let ([days (hash-ref (adt-value-fields *tesl_case_2) 'days)]) (thsl-src! "example/learn/lesson39-case-where-guards.tesl" 94 (list (cons 'label label) (cons 'days days)) (lambda () (raw-value "overdue")))))] [(and (and (adt-value? *tesl_case_2) (eq? (adt-value-variant *tesl_case_2) 'Deadline)) (let ([label (hash-ref (adt-value-fields *tesl_case_2) 'label)]) (let ([days (hash-ref (adt-value-fields *tesl_case_2) 'days)]) (<= *days 3)))) (let ([label (hash-ref (adt-value-fields *tesl_case_2) 'label)]) (let ([days (hash-ref (adt-value-fields *tesl_case_2) 'days)]) (thsl-src! "example/learn/lesson39-case-where-guards.tesl" 95 (list (cons 'label label) (cons 'days days)) (lambda () (raw-value "soon")))))] [(and (adt-value? *tesl_case_2) (eq? (adt-value-variant *tesl_case_2) 'Deadline)) (thsl-src! "example/learn/lesson39-case-where-guards.tesl" 96 (list) (lambda () (raw-value "future")))])))))
