...
(define/pow
  ...
  #:returns Integer
  (thsl-src! "example/learn/lesson52-maybe-proof.tesl" 72 (list (cons 't *t)) (lambda () (let ([tesl_case_1 *t]) (cond [(and (adt-value? *tesl_case_1) (eq? (adt-value-variant *tesl_case_1) 'Leaf)) (raw-value 0)] [(and (adt-value? *tesl_case_1) (eq? (adt-value-variant *tesl_case_1) 'Node)) (let ([l (hash-ref (adt-value-fields *tesl_case_1) 'left)]) (let ([r (hash-ref (adt-value-fields *tesl_case_1) 'right)]) (raw-value (+ (+ 1 (raw-value (treeSize *l))) (raw-value (treeSize *r))))))])))))

(define/pow
  (treeSum [t : PositiveTree])
  #:returns Integer
  (thsl-src! "example/learn/lesson52-maybe-proof.tesl" 77 (list (cons 't *t)) (lambda () (let ([tesl_case_2 *t]) (cond [(and (adt-value? *tesl_case_2) (eq? (adt-value-variant *tesl_case_2) 'Leaf)) (raw-value 0)] [(and (adt-value? *tesl_case_2) (eq? (adt-value-variant *tesl_case_2) 'Node)) (let ([l (hash-ref (adt-value-fields *tesl_case_2) 'left)]) (let ([v (hash-ref (adt-value-fields *tesl_case_2) 'value)]) (let ([r (hash-ref (adt-value-fields *tesl_case_2) 'right)]) (raw-value (+ (+ *v (raw-value (treeSum *l))) (raw-value (treeSum *r)))))))])))))
...
(define/pow
  ...
  (thsl-src! "example/learn/lesson52-maybe-proof.tesl" 112 (list (cons 't *t)) (lambda () (let ([tesl_case_5 *t]) (cond [(and (adt-value? *tesl_case_5) (eq? (adt-value-variant *tesl_case_5) 'Leaf)) Nothing] [(and (and (adt-value? *tesl_case_5) (eq? (adt-value-variant *tesl_case_5) 'Node)) (let ([tesl_case_5_f2 (raw-value (hash-ref (adt-value-fields *tesl_case_5) 'right))]) (and (adt-value? *tesl_case_5_f2) (eq? (adt-value-variant *tesl_case_5_f2) 'Leaf)))) (let ([cur (hash-ref (adt-value-fields *tesl_case_5) 'value)]) (let ([tesl_case_5_f2 (raw-value (hash-ref (adt-value-fields *tesl_case_5) 'right))]) (raw-value (Something cur))))] [(and (adt-value? *tesl_case_5) (eq? (adt-value-variant *tesl_case_5) 'Node)) (let ([r (hash-ref (adt-value-fields *tesl_case_5) 'right)]) (findMax *r))])))))

(define/pow
  (doubleMin [t : PositiveTree])
  #:returns Integer
  (let ([m (thsl-src! "example/learn/lesson52-maybe-proof.tesl" 118 (list (cons 't *t)) (lambda () (findMin t)))]) (thsl-src! "example/learn/lesson52-maybe-proof.tesl" 119 (list (cons 'm *m) (cons 't *t)) (lambda () (let ([tesl_case_6 (raw-value m)]) (cond [(and (adt-value? *tesl_case_6) (eq? (adt-value-variant *tesl_case_6) 'Left)) (raw-value 0)] [(and (adt-value? *tesl_case_6) (eq? (adt-value-variant *tesl_case_6) 'Right)) (let ([v (hash-ref (adt-value-fields *tesl_case_6) 'value)]) (raw-value (+ (raw-value (needPositive v)) (raw-value (needPositive v)))))]))))))
...
(define-handler
  (getMin)
  #:returns Integer
  (let ([m (thsl-src! "example/learn/lesson52-maybe-proof.tesl" 193 (list) (lambda () (findMin (exampleTree))))]) (thsl-src! "example/learn/lesson52-maybe-proof.tesl" 194 (list (cons 'm *m)) (lambda () (let ([tesl_case_10 (raw-value m)]) (cond [(and (adt-value? *tesl_case_10) (eq? (adt-value-variant *tesl_case_10) 'Left)) 0] [(and (adt-value? *tesl_case_10) (eq? (adt-value-variant *tesl_case_10) 'Right)) (let ([v (hash-ref (adt-value-fields *tesl_case_10) 'value)]) (needPositive *v))]))))))

(define-handler
  (getMinAlt)
  #:returns Integer
  (let ([m (thsl-src! "example/learn/lesson52-maybe-proof.tesl" 199 (list) (lambda () (findMinAlt (exampleTree))))]) (thsl-src! "example/learn/lesson52-maybe-proof.tesl" 200 (list (cons 'm *m)) (lambda () (let ([tesl_case_11 (raw-value m)]) (cond [(and (adt-value? *tesl_case_11) (eq? (adt-value-variant *tesl_case_11) 'CustomLeft)) 0] [(and (adt-value? *tesl_case_11) (eq? (adt-value-variant *tesl_case_11) 'CustomRight)) (let ([v (hash-ref (adt-value-fields *tesl_case_11) 'right)]) (needPositive *v))]))))))

(define-handler
  (getMax)
  #:returns Integer
  (let ([m (thsl-src! "example/learn/lesson52-maybe-proof.tesl" 205 (list) (lambda () (findMax (exampleTree))))]) (thsl-src! "example/learn/lesson52-maybe-proof.tesl" 206 (list (cons 'm *m)) (lambda () (let ([tesl_case_12 (raw-value m)]) (cond [(and (adt-value? *tesl_case_12) (eq? (adt-value-variant *tesl_case_12) 'Nothing)) 0] [(and (adt-value? *tesl_case_12) (eq? (adt-value-variant *tesl_case_12) 'Something)) (let ([v (hash-ref (adt-value-fields *tesl_case_12) 'value)]) (needPositive *v))]))))))
