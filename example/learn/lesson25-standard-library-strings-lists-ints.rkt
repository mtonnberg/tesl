...
(define/pow
  ...
  (thsl-src! "example/learn/lesson25-standard-library-strings-lists-ints.tesl" 223 (list (cons 'numerator *numerator) (cons 'rawDenom *rawDenom)) (lambda () (let/check ([tesl_checked_1 (tesl_import_Int_nonZero rawDenom)]) (let ([denom tesl_checked_1]) (raw-value (Something (tesl_import_Int_divide *numerator denom))))))))
