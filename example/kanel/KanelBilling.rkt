...
(define-checker
  ...
  (let ([found (thsl-src! "example/kanel/KanelBilling.tesl" 49 (list (cons 'invoiceId *invoiceId)) (lambda () (let ([tesl_match (select-one (from Invoice) (where (==. (entity-field-ref Invoice 'id) invoiceId)))]) (if tesl_match (Something tesl_match) Nothing))))]) (thsl-src-control! "example/kanel/KanelBilling.tesl" 50 (list (cons 'found *found) (cons 'invoiceId *invoiceId)) (lambda () (let ([tesl_case_0 (raw-value found)]) (cond [(and (adt-value? *tesl_case_0) (eq? (adt-value-variant *tesl_case_0) 'Nothing)) (thsl-src! "example/kanel/KanelBilling.tesl" 51 (list) (lambda () (reject "invoice not found" #:http-code 404)))] [(and (adt-value? *tesl_case_0) (eq? (adt-value-variant *tesl_case_0) 'Something)) (let ([inv (hash-ref (adt-value-fields *tesl_case_0) 'value)]) (thsl-src! "example/kanel/KanelBilling.tesl" 53 (list (cons 'inv inv)) (lambda () (let ([tesl_case_1 (tesl-dot/runtime inv 'status)]) (cond [(and (adt-value? *tesl_case_1) (eq? (adt-value-variant *tesl_case_1) 'Draft)) (thsl-src! "example/kanel/KanelBilling.tesl" 54 (list) (lambda () (accept (InvoiceDraft invoiceId) #:value *invoiceId)))] [(and (adt-value? *tesl_case_1) (eq? (adt-value-variant *tesl_case_1) 'Approved)) (thsl-src! "example/kanel/KanelBilling.tesl" 55 (list) (lambda () (reject "invoice is already approved and cannot be modified" #:http-code 422)))] [(and (adt-value? *tesl_case_1) (eq? (adt-value-variant *tesl_case_1) 'Sent)) (thsl-src! "example/kanel/KanelBilling.tesl" 56 (list) (lambda () (reject "invoice has already been sent" #:http-code 422)))] [(and (adt-value? *tesl_case_1) (eq? (adt-value-variant *tesl_case_1) 'Paid)) (thsl-src! "example/kanel/KanelBilling.tesl" 57 (list) (lambda () (reject "invoice has been paid" #:http-code 422)))] [(and (adt-value? *tesl_case_1) (eq? (adt-value-variant *tesl_case_1) 'Overdue)) (thsl-src! "example/kanel/KanelBilling.tesl" 58 (list) (lambda () (reject "invoice is overdue \u2014 contact support" #:http-code 422)))])))))]))))))
...
(define-handler
  ...
  #:capabilities [kanelDbRead]
  #:returns Invoice
  (thsl-src! "example/kanel/KanelBilling.tesl" 104 (list (cons 'session *session) (cons 'orgId *orgId) (cons 'invoiceId *invoiceId)) (lambda () (let/check ([tesl_checked_3 (checkOrgAdmin (raw-value session.userId) orgId)]) (let ([_adminUserId tesl_checked_3]) (let ([found (let ([tesl_match (select-one (from Invoice) (where (==. (entity-field-ref Invoice 'id) invoiceId)) (where (==. (entity-field-ref Invoice 'orgId) orgId)))]) (if tesl_match (Something tesl_match) Nothing))]) (let ([tesl_case_4 (raw-value found)]) (cond [(and (adt-value? *tesl_case_4) (eq? (adt-value-variant *tesl_case_4) 'Nothing)) (thsl-src! "example/kanel/KanelBilling.tesl" 107 (list) (lambda () (reject "invoice not found" #:http-code 404)))] [(and (adt-value? *tesl_case_4) (eq? (adt-value-variant *tesl_case_4) 'Something)) (let ([inv (hash-ref (adt-value-fields *tesl_case_4) 'value)]) (thsl-src! "example/kanel/KanelBilling.tesl" 108 (list (cons 'inv inv)) (lambda () *inv)))]))))))))

(define-handler
  (listInvoicesHandler [session : KanelSession ::: (Authenticated session)] [orgId : String ::: (ValidOrgId orgId)])
  #:capabilities [kanelDbRead]
  #:returns (List Invoice)
  (thsl-src! "example/kanel/KanelBilling.tesl" 115 (list (cons 'session *session) (cons 'orgId *orgId)) (lambda () (let/check ([tesl_checked_5 (checkOrgAdmin (raw-value session.userId) orgId)]) (let ([_adminUserId tesl_checked_5]) (select-many (from Invoice) (where (==. (entity-field-ref Invoice 'orgId) orgId))))))))
...
(define-handler
  ...
  #:returns Invoice
  (thsl-src! "example/kanel/KanelBilling.tesl" 138 (list (cons 'session *session) (cons 'orgId *orgId) (cons 'invoiceId *invoiceId)) (lambda () (let/check ([tesl_checked_8 (checkOrgAdmin (raw-value session.userId) orgId)]) (let ([_adminUserId tesl_checked_8]) (let ([found (let ([tesl_match (select-one (from Invoice) (where (==. (entity-field-ref Invoice 'id) invoiceId)) (where (==. (entity-field-ref Invoice 'orgId) orgId)))]) (if tesl_match (Something tesl_match) Nothing))]) (let ([tesl_case_9 (raw-value found)]) (cond [(and (adt-value? *tesl_case_9) (eq? (adt-value-variant *tesl_case_9) 'Nothing)) (thsl-src! "example/kanel/KanelBilling.tesl" 141 (list) (lambda () (reject "invoice not found" #:http-code 404)))] [(and (adt-value? *tesl_case_9) (eq? (adt-value-variant *tesl_case_9) 'Something)) (let ([inv (hash-ref (adt-value-fields *tesl_case_9) 'value)]) (thsl-src! "example/kanel/KanelBilling.tesl" 143 (list (cons 'inv inv)) (lambda () (let ([tesl_case_10 (tesl-dot/runtime inv 'status)]) (cond [(and (adt-value? *tesl_case_10) (eq? (adt-value-variant *tesl_case_10) 'Approved)) (thsl-src! "example/kanel/KanelBilling.tesl" 145 (list) (lambda () (car (update-many! (from Invoice) (hash (entity-field-ref Invoice 'status) Sent) (where (==. (entity-field-ref Invoice 'id) invoiceId))))))] [(and (adt-value? *tesl_case_10) (eq? (adt-value-variant *tesl_case_10) 'Draft)) (thsl-src! "example/kanel/KanelBilling.tesl" 149 (list) (lambda () (reject "invoice must be approved before sending" #:http-code 422)))] [(and (adt-value? *tesl_case_10) (eq? (adt-value-variant *tesl_case_10) 'Sent)) (thsl-src! "example/kanel/KanelBilling.tesl" 150 (list) (lambda () (reject "invoice already sent" #:http-code 422)))] [(and (adt-value? *tesl_case_10) (eq? (adt-value-variant *tesl_case_10) 'Paid)) (thsl-src! "example/kanel/KanelBilling.tesl" 151 (list) (lambda () (reject "invoice already paid" #:http-code 422)))] [(and (adt-value? *tesl_case_10) (eq? (adt-value-variant *tesl_case_10) 'Overdue)) (thsl-src! "example/kanel/KanelBilling.tesl" 152 (list) (lambda () (reject "invoice is overdue" #:http-code 422)))])))))]))))))))
...
(define-handler
  ...
  #:capabilities [kanelDbRead kanelDbWrite]
  #:returns Invoice
  (thsl-src! "example/kanel/KanelBilling.tesl" 160 (list (cons 'session *session) (cons 'orgId *orgId) (cons 'invoiceId *invoiceId)) (lambda () (let/check ([tesl_checked_11 (checkOrgAdmin (raw-value session.userId) orgId)]) (let ([_adminUserId tesl_checked_11]) (let ([found (let ([tesl_match (select-one (from Invoice) (where (==. (entity-field-ref Invoice 'id) invoiceId)) (where (==. (entity-field-ref Invoice 'orgId) orgId)))]) (if tesl_match (Something tesl_match) Nothing))]) (let ([tesl_case_12 (raw-value found)]) (cond [(and (adt-value? *tesl_case_12) (eq? (adt-value-variant *tesl_case_12) 'Nothing)) (thsl-src! "example/kanel/KanelBilling.tesl" 163 (list) (lambda () (reject "invoice not found" #:http-code 404)))] [(and (adt-value? *tesl_case_12) (eq? (adt-value-variant *tesl_case_12) 'Something)) (let ([inv (hash-ref (adt-value-fields *tesl_case_12) 'value)]) (thsl-src! "example/kanel/KanelBilling.tesl" 165 (list (cons 'inv inv)) (lambda () (let ([tesl_case_13 (tesl-dot/runtime inv 'status)]) (cond [(and (adt-value? *tesl_case_13) (eq? (adt-value-variant *tesl_case_13) 'Sent)) (thsl-src! "example/kanel/KanelBilling.tesl" 167 (list) (lambda () (car (update-many! (from Invoice) (hash (entity-field-ref Invoice 'status) Paid) (where (==. (entity-field-ref Invoice 'id) invoiceId))))))] [(and (adt-value? *tesl_case_13) (eq? (adt-value-variant *tesl_case_13) 'Approved)) (thsl-src! "example/kanel/KanelBilling.tesl" 171 (list) (lambda () (reject "invoice must be sent before marking paid" #:http-code 422)))] [(and (adt-value? *tesl_case_13) (eq? (adt-value-variant *tesl_case_13) 'Draft)) (thsl-src! "example/kanel/KanelBilling.tesl" 172 (list) (lambda () (reject "invoice must be approved and sent before marking paid" #:http-code 422)))] [(and (adt-value? *tesl_case_13) (eq? (adt-value-variant *tesl_case_13) 'Paid)) (thsl-src! "example/kanel/KanelBilling.tesl" 173 (list) (lambda () (reject "invoice already paid" #:http-code 422)))] [(and (adt-value? *tesl_case_13) (eq? (adt-value-variant *tesl_case_13) 'Overdue)) (thsl-src! "example/kanel/KanelBilling.tesl" 175 (list) (lambda () (car (update-many! (from Invoice) (hash (entity-field-ref Invoice 'status) Paid) (where (==. (entity-field-ref Invoice 'id) invoiceId))))))])))))]))))))))
