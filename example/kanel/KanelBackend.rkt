        ...
        (call-with-api-test-subscriptions
          (lambda ()
            (with-capabilities (kanelDbRead kanelDbWrite)
              (let ([_ (insert-one! KanelUser (tesl-hash 'id "usr-seeded" 'email "seeded@example.com" 'passwordHash "password123" 'displayName "Seeded Alice" 'createdAt 0))]) (let ([_ (insert-one! Org (tesl-hash 'id "org-seeded" 'name "Seeded Org" 'slug "seeded-org" 'createdAt 0))]) (insert-one! OrgMembership (tesl-hash 'id "mem-seeded" 'orgId "org-seeded" 'userId "usr-seeded" 'role RoleAdmin 'joinedAt 0))))
        ...
        (call-with-api-test-subscriptions
          (lambda ()
            (with-capabilities (kanelDbRead kanelDbWrite kanelQueue kanelPubSub notifyWorkerCap random time)
              (let ([_ (insert-one! KanelUser (tesl-hash 'id "usr-reporter" 'email "reporter@example.com" 'passwordHash "password123" 'displayName "Reporter" 'createdAt 0))]) (let ([_ (insert-one! KanelUser (tesl-hash 'id "usr-commenter" 'email "commenter@example.com" 'passwordHash "password123" 'displayName "Commenter" 'createdAt 0))]) (let ([_ (insert-one! Org (tesl-hash 'id "org-notify" 'name "Notify Org" 'slug "notify-org" 'createdAt 0))]) (let ([_ (insert-one! OrgMembership (tesl-hash 'id "mem-reporter" 'orgId "org-notify" 'userId "usr-reporter" 'role RoleAdmin 'joinedAt 0))]) (let ([_ (insert-one! OrgMembership (tesl-hash 'id "mem-commenter" 'orgId "org-notify" 'userId "usr-commenter" 'role RoleMember 'joinedAt 0))]) (let ([_ (insert-one! Project (tesl-hash 'id "proj-notify" 'orgId "org-notify" 'name "Notify project" 'description "Exercise api tests" 'archived #f 'createdAt 0))]) (insert-one! Issue (tesl-hash 'id "iss-notify" 'projectId "proj-notify" 'orgId "org-notify" 'title "Ship api-tests" 'description "Expand coverage" 'status Backlog 'assigneeId Nothing 'reporterId "usr-reporter" 'estimate 60 'dueAt Nothing 'createdAt 0 'updatedAt 0))))))))
    ...
    (call-with-fresh-memory-db (list KanelDatabase)
      (lambda ()
        (call-with-api-test-subscriptions
          (lambda ()
            (with-capabilities (kanelDbRead kanelDbWrite kanelQueue kanelPubSub notifyWorkerCap random time)
              (let ([_ (insert-one! KanelUser (tesl-hash 'id "usr-blocked" 'email "blocked@example.com" 'passwordHash "password123" 'displayName "Blocked Reporter" 'createdAt 0))]) (let ([_ (insert-one! KanelUser (tesl-hash 'id "usr-commenter" 'email "commenter@example.com" 'passwordHash "password123" 'displayName "Commenter" 'createdAt 0))]) (let ([_ (insert-one! Org (tesl-hash 'id "org-failed-notify" 'name "Failed Notify Org" 'slug "failed-notify-org" 'createdAt 0))]) (let ([_ (insert-one! OrgMembership (tesl-hash 'id "mem-blocked" 'orgId "org-failed-notify" 'userId "usr-blocked" 'role RoleAdmin 'joinedAt 0))]) (let ([_ (insert-one! OrgMembership (tesl-hash 'id "mem-commenter" 'orgId "org-failed-notify" 'userId "usr-commenter" 'role RoleMember 'joinedAt 0))]) (let ([_ (insert-one! Project (tesl-hash 'id "proj-failed-notify" 'orgId "org-failed-notify" 'name "Failure project" 'description "Exercise dead-letter handling" 'archived #f 'createdAt 0))]) (insert-one! Issue (tesl-hash 'id "iss-failed-notify" 'projectId "proj-failed-notify" 'orgId "org-failed-notify" 'title "Queue failure" 'description "Expect dead-letter delivery" 'status Backlog 'assigneeId Nothing 'reporterId "usr-blocked" 'estimate 30 'dueAt Nothing 'createdAt 0 'updatedAt 0))))))))
        ...
        (call-with-api-test-subscriptions
          (lambda ()
            (with-capabilities (kanelDbRead kanelDbWrite kanelPubSub time)
              (let ([_ (insert-one! KanelUser (tesl-hash 'id "usr-status-test" 'email "statustest@example.com" 'passwordHash "password123" 'displayName "Status Tester" 'createdAt 0))]) (let ([_ (insert-one! Org (tesl-hash 'id "org-status-test" 'name "Status Test Org" 'slug "status-test-org" 'createdAt 0))]) (let ([_ (insert-one! OrgMembership (tesl-hash 'id "mem-status-test" 'orgId "org-status-test" 'userId "usr-status-test" 'role RoleAdmin 'joinedAt 0))]) (let ([_ (insert-one! Project (tesl-hash 'id "proj-status-test" 'orgId "org-status-test" 'name "Status Test Project" 'description "For testing status transitions" 'archived #f 'createdAt 0))]) (insert-one! Issue (tesl-hash 'id "iss-status-test" 'projectId "proj-status-test" 'orgId "org-status-test" 'title "Transition test issue" 'description "Testing status machine" 'status Backlog 'assigneeId Nothing 'reporterId "usr-status-test" 'estimate 30 'dueAt Nothing 'createdAt 0 'updatedAt 0))))))
