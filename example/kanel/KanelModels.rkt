...
(define-checker
  ...
  (thsl-src! "example/kanel/KanelModels.tesl" 226 (list (cons 'orgId *orgId)) (lambda () (if (tesl-lt? (raw-value (tesl_import_String_length *orgId)) 3) (reject "invalid org id" #:http-code 400) (accept (ValidOrgId orgId) #:value *orgId)))))

(define-checker
  (checkProjectId [projectId : String])
  #:returns [projectId : String ::: (ValidProjectId projectId)]
  (thsl-src! "example/kanel/KanelModels.tesl" 234 (list (cons 'projectId *projectId)) (lambda () (if (tesl-lt? (raw-value (tesl_import_String_length *projectId)) 3) (reject "invalid project id" #:http-code 400) (accept (ValidProjectId projectId) #:value *projectId)))))

(define-checker
  (checkIssueId [issueId : String])
  #:returns [issueId : String ::: (ValidIssueId issueId)]
  (thsl-src! "example/kanel/KanelModels.tesl" 242 (list (cons 'issueId *issueId)) (lambda () (if (tesl-lt? (raw-value (tesl_import_String_length *issueId)) 3) (reject "invalid issue id" #:http-code 400) (accept (ValidIssueId issueId) #:value *issueId)))))

(define-checker
  (checkInvoiceId [invoiceId : String])
  #:returns [invoiceId : String ::: (ValidInvoiceId invoiceId)]
  (thsl-src! "example/kanel/KanelModels.tesl" 250 (list (cons 'invoiceId *invoiceId)) (lambda () (if (tesl-lt? (raw-value (tesl_import_String_length *invoiceId)) 3) (reject "invalid invoice id" #:http-code 400) (accept (ValidInvoiceId invoiceId) #:value *invoiceId)))))

(define-checker
  (checkUserId [userId : String])
  #:returns [userId : String ::: (ValidUserId userId)]
  (thsl-src! "example/kanel/KanelModels.tesl" 258 (list (cons 'userId *userId)) (lambda () (if (tesl-lt? (raw-value (tesl_import_String_length *userId)) 3) (reject "invalid user id" #:http-code 400) (accept (ValidUserId userId) #:value *userId)))))

(define-checker
  (checkTargetUserId [targetUserId : String])
  #:returns [targetUserId : String ::: (ValidUserId targetUserId)]
  (thsl-src! "example/kanel/KanelModels.tesl" 264 (list (cons 'targetUserId *targetUserId)) (lambda () (if (tesl-lt? (raw-value (tesl_import_String_length *targetUserId)) 3) (reject "invalid user id" #:http-code 400) (accept (ValidUserId targetUserId) #:value *targetUserId)))))
