...
(define/pow
  ...
  (thsl-src! "example/kanel/KanelDB.tesl" 107 (list (cons 'orgId *orgId) (cons 'name *name) (cons 'slug *slug)) (lambda () (insert-one! Org (hash 'id orgId 'name name 'slug slug 'createdAt (raw-value (nowMillis)))))))
...
(define/pow
  ...
  (thsl-src! "example/kanel/KanelDB.tesl" 121 (list (cons 'memberId *memberId) (cons 'orgId *orgId) (cons 'adminId *adminId) (cons 'targetUserId *targetUserId) (cons 'role *role)) (lambda () (insert-one! OrgMembership (hash 'id memberId 'orgId orgId 'userId targetUserId 'role role 'joinedAt (raw-value (nowMillis)))))))
...
(define/pow
  ...
  (thsl-src! "example/kanel/KanelDB.tesl" 146 (list (cons 'userId *userId) (cons 'email *email) (cons 'displayName *displayName) (cons 'passwordHash *passwordHash)) (lambda () (insert-one! KanelUser (hash 'id userId 'email email 'passwordHash passwordHash 'displayName displayName 'createdAt (raw-value (nowMillis)))))))
...
(define/pow
  ...
  (thsl-src! "example/kanel/KanelDB.tesl" 160 (list (cons 'projectId *projectId) (cons 'orgId *orgId) (cons 'adminId *adminId) (cons 'name *name) (cons 'description *description)) (lambda () (insert-one! Project (hash 'id projectId 'orgId orgId 'name name 'description description 'archived #f 'createdAt (raw-value (nowMillis)))))))

(define/pow
  (dbArchiveProject [projectId : String] [orgId : String] [adminId : String ::: (OrgAdmin adminId orgId)])
  #:capabilities [kanelDbWrite]
  #:returns Project
  (thsl-src! "example/kanel/KanelDB.tesl" 164 (list (cons 'projectId *projectId) (cons 'orgId *orgId) (cons 'adminId *adminId)) (lambda () (car (update-many! (from Project) (hash (entity-field-ref Project 'archived) #t) (where (==. (entity-field-ref Project 'id) projectId)))))))
...
(define/pow
  ...
  (thsl-src! "example/kanel/KanelDB.tesl" 181 (list (cons 'issueId *issueId) (cons 'projectId *projectId) (cons 'orgId *orgId) (cons 'userId *userId) (cons 'title *title) (cons 'description *description) (cons 'estimate *estimate)) (lambda () (insert-one! Issue (hash 'id issueId 'projectId projectId 'orgId orgId 'title title 'description description 'status Backlog 'assigneeId Nothing 'reporterId userId 'estimate estimate 'dueAt Nothing 'createdAt (raw-value (nowMillis)) 'updatedAt (raw-value (nowMillis)))))))
...
(define/pow
  ...
  #:capabilities [kanelDbWrite time]
  #:returns Issue
  (thsl-src! "example/kanel/KanelDB.tesl" 191 (list (cons 'issueId *issueId) (cons 'orgId *orgId) (cons 'userId *userId) (cons 'title *title) (cons 'description *description) (cons 'estimate *estimate) (cons 'assigneeId *assigneeId)) (lambda () (car (update-many! (from Issue) (hash (entity-field-ref Issue 'title) title (entity-field-ref Issue 'description) description (entity-field-ref Issue 'estimate) estimate (entity-field-ref Issue 'assigneeId) assigneeId (entity-field-ref Issue 'updatedAt) (raw-value (nowMillis))) (where (==. (entity-field-ref Issue 'id) issueId)))))))

(define/pow
  (dbUpdateIssueStatus [issueId : String] [newStatus : IssueStatus] [orgId : String] [userId : String ::: (OrgMember userId orgId)])
  #:capabilities [kanelDbWrite time]
  #:returns Issue
  (thsl-src! "example/kanel/KanelDB.tesl" 202 (list (cons 'issueId *issueId) (cons 'newStatus *newStatus) (cons 'orgId *orgId) (cons 'userId *userId)) (lambda () (car (update-many! (from Issue) (hash (entity-field-ref Issue 'status) newStatus (entity-field-ref Issue 'updatedAt) (raw-value (nowMillis))) (where (==. (entity-field-ref Issue 'id) issueId)))))))
...
(define/pow
  ...
  (thsl-src! "example/kanel/KanelDB.tesl" 212 (list (cons 'commentId *commentId) (cons 'issueId *issueId) (cons 'orgId *orgId) (cons 'authorId *authorId) (cons 'body *body)) (lambda () (insert-one! IssueComment (hash 'id commentId 'issueId issueId 'authorId authorId 'body body 'createdAt (raw-value (nowMillis)))))))
...
(define/pow
  ...
  #:capabilities [kanelDbWrite]
  #:returns Unit
  (thsl-src! "example/kanel/KanelDB.tesl" 234 (list (cons 'orgId *orgId) (cons 'adminId *adminId) (cons 'invoiceId *invoiceId)) (lambda () (void (update-many! (from TimeEntry) (hash (entity-field-ref TimeEntry 'invoiceId) invoiceId) (where (==. (entity-field-ref TimeEntry 'orgId) orgId)) (where (==. (entity-field-ref TimeEntry 'invoiceId) "")))))))
