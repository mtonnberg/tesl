...
(define/pow
  (dbUpdateIssueFields [issueId : String ::: (NotDone issueId)] [orgId : String] [userId : String ::: (OrgMember userId orgId)] [title : String ::: (ValidTitle title)] [description : String ::: (ValidDescription description)] [estimate : Integer ::: (PositiveEstimate estimate)] [assigneeId : (Maybe String)])
  #:capabilities [kanelDbWrite time]
  #:returns Issue
