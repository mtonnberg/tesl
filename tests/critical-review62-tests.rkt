...
(define-checker
  ...
  (thsl-src! "tests/critical-review62-tests.tesl" 81 (list (cons 'n *n)) (lambda () (if (> *n 0) (accept (A n) #:value *n) (reject "bad" #:http-code 400)))))

(define-checker
  (checkB [n : Integer ::: (A n)])
  #:returns [n : Integer ::: ((A n) && (B n))]
  (thsl-src! "tests/critical-review62-tests.tesl" 87 (list (cons 'n *n)) (lambda () (if (> *n 1) (accept ((A n) && (B n)) #:value *n) (reject "bad" #:http-code 400)))))

(define-checker
  (checkC [n : Integer ::: ((A n) && (B n))])
  #:returns [n : Integer ::: ((A n) && ((B n) && (C n)))]
  (thsl-src! "tests/critical-review62-tests.tesl" 93 (list (cons 'n *n)) (lambda () (if (> *n 2) (accept ((A n) && ((B n) && (C n))) #:value *n) (reject "bad" #:http-code 400)))))

(define-checker
  (checkD [n : Integer ::: ((A n) && ((B n) && (C n)))])
  #:returns [n : Integer ::: ((A n) && ((B n) && ((C n) && (D n))))]
  (thsl-src! "tests/critical-review62-tests.tesl" 99 (list (cons 'n *n)) (lambda () (if (> *n 3) (accept ((A n) && ((B n) && ((C n) && (D n)))) #:value *n) (reject "bad" #:http-code 400)))))

(define-checker
  (checkPos [n : Integer])
  #:returns [n : Integer ::: (IsPositive n)]
  (thsl-src! "tests/critical-review62-tests.tesl" 105 (list (cons 'n *n)) (lambda () (if (> *n 0) (accept (IsPositive n) #:value *n) (reject "not positive" #:http-code 400)))))

(define-checker
  (checkSmall [n : Integer])
  #:returns [n : Integer ::: (IsSmall n)]
  (thsl-src! "tests/critical-review62-tests.tesl" 111 (list (cons 'n *n)) (lambda () (if (< *n 100) (accept (IsSmall n) #:value *n) (reject "too big" #:http-code 400)))))

(define-checker
  (checkTitle [s : String])
  #:returns [s : String ::: (TitleSafe s)]
  (thsl-src! "tests/critical-review62-tests.tesl" 117 (list (cons 's *s)) (lambda () (if (> (raw-value (tesl_import_String_length *s)) 0) (accept (TitleSafe s) #:value *s) (reject "empty title" #:http-code 400)))))

(define-checker
  (checkEven [n : Integer])
  #:returns [n : Integer ::: (IsEven n)]
  (thsl-src! "tests/critical-review62-tests.tesl" 123 (list (cons 'n *n)) (lambda () (if (< *n 0) (reject "negative" #:http-code 400) (if (tesl-equal? *n 0) (accept (IsEven n) #:value *n) (let/check ([tesl-checked-0 (checkOdd (- *n 1))]) (let ([_odd tesl-checked-0]) (accept (IsEven n) #:value *n))))))))

(define-checker
  (checkOdd [n : Integer])
  #:returns [n : Integer ::: (IsOdd n)]
  (thsl-src! "tests/critical-review62-tests.tesl" 132 (list (cons 'n *n)) (lambda () (if (<= *n 0) (reject "not odd" #:http-code 400) (if (tesl-equal? *n 1) (accept (IsOdd n) #:value *n) (let/check ([tesl-checked-1 (checkEven (- *n 1))]) (let ([_even tesl-checked-1]) (accept (IsOdd n) #:value *n))))))))
...
(define-checker
  ...
  #:returns [n : Integer ::: ((A n) && (B n))]
  (thsl-src! "tests/critical-review62-tests.tesl" 205 (list (cons 'n *n)) (lambda () (if (> *n 1) (accept ((B n) && (A n)) #:value *n) (reject "bad" #:http-code 400)))))
...
(define-checker
  ...
  (thsl-src! "tests/critical-review62-tests.tesl" 439 (list (cons 'u *u)) (lambda () (if (> (raw-value (tesl_import_String_length (raw-value u.value))) 0) (accept (ValidUser u) #:value *u) (reject "empty user id" #:http-code 400)))))

(define-checker
  (checkProject [p : ProjectId])
  #:returns [p : ProjectId ::: (ValidProject p)]
  (thsl-src! "tests/critical-review62-tests.tesl" 445 (list (cons 'p *p)) (lambda () (if (> (raw-value (tesl_import_String_length (raw-value p.value))) 0) (accept (ValidProject p) #:value *p) (reject "empty project id" #:http-code 400)))))
...
(define/pow
  ...
  #:returns SafePost
  (thsl-src! "tests/critical-review62-tests.tesl" 555 (list (cons 'p *p) (cons 'newCount *newCount)) (lambda () (tesl-record-update *p (hash 'count *newCount)))))
