    ...
    (call-with-fresh-memory-db '()
      (lambda ()
        (call-with-api-test-subscriptions
          (lambda ()
            (define resp (thsl-src! "tests/critical-review-48-auth-api-tests.tesl" 220 (list) (lambda () (dispatch-api-test-request R48AuthServer 'post (list "double") #:headers (hash) #:body (hash (string->symbol "value") 5) #:capabilities '()))))
  ...
  (test-case "auth + single proof: positive doubled"
    (call-with-fresh-memory-db '()
      (lambda ()
        (call-with-api-test-subscriptions
          (lambda ()
            (define resp (thsl-src! "tests/critical-review-48-auth-api-tests.tesl" 225 (list) (lambda () (dispatch-api-test-request R48AuthServer 'post (list "double") #:cookie "user=alice" #:headers (hash) #:body (hash (string->symbol "value") 5) #:capabilities '()))))
  ...
  (test-case "auth + single proof: zero rejected 400"
    (call-with-fresh-memory-db '()
      (lambda ()
        (call-with-api-test-subscriptions
          (lambda ()
            (define resp (thsl-src! "tests/critical-review-48-auth-api-tests.tesl" 231 (list) (lambda () (dispatch-api-test-request R48AuthServer 'post (list "double") #:cookie "user=alice" #:headers (hash) #:body (hash (string->symbol "value") 0) #:capabilities '()))))
  ...
  (test-case "auth + single proof: negative rejected 400"
    (call-with-fresh-memory-db '()
      (lambda ()
        (call-with-api-test-subscriptions
          (lambda ()
            (define resp (thsl-src! "tests/critical-review-48-auth-api-tests.tesl" 236 (list) (lambda () (dispatch-api-test-request R48AuthServer 'post (list "double") #:cookie "user=alice" #:headers (hash) #:body (hash (string->symbol "value") -5) #:capabilities '()))))
  ...
  (test-case "conj wrapper: 50 tripled"
    (call-with-fresh-memory-db '()
      (lambda ()
        (call-with-api-test-subscriptions
          (lambda ()
            (define resp (thsl-src! "tests/critical-review-48-auth-api-tests.tesl" 245 (list) (lambda () (dispatch-api-test-request R48AuthServer 'post (list "triple-conj") #:cookie "user=alice" #:headers (hash) #:body (hash (string->symbol "value") 50) #:capabilities '()))))
  ...
  (test-case "conj wrapper: boundary 1"
    (call-with-fresh-memory-db '()
      (lambda ()
        (call-with-api-test-subscriptions
          (lambda ()
            (define resp (thsl-src! "tests/critical-review-48-auth-api-tests.tesl" 251 (list) (lambda () (dispatch-api-test-request R48AuthServer 'post (list "triple-conj") #:cookie "user=alice" #:headers (hash) #:body (hash (string->symbol "value") 1) #:capabilities '()))))
  ...
  (test-case "conj wrapper: boundary 99"
    (call-with-fresh-memory-db '()
      (lambda ()
        (call-with-api-test-subscriptions
          (lambda ()
            (define resp (thsl-src! "tests/critical-review-48-auth-api-tests.tesl" 257 (list) (lambda () (dispatch-api-test-request R48AuthServer 'post (list "triple-conj") #:cookie "user=alice" #:headers (hash) #:body (hash (string->symbol "value") 99) #:capabilities '()))))
  ...
  (test-case "conj wrapper: rejects 0"
    (call-with-fresh-memory-db '()
      (lambda ()
        (call-with-api-test-subscriptions
          (lambda ()
            (define resp (thsl-src! "tests/critical-review-48-auth-api-tests.tesl" 263 (list) (lambda () (dispatch-api-test-request R48AuthServer 'post (list "triple-conj") #:cookie "user=alice" #:headers (hash) #:body (hash (string->symbol "value") 0) #:capabilities '()))))
  ...
  (test-case "conj wrapper: rejects 100"
    (call-with-fresh-memory-db '()
      (lambda ()
        (call-with-api-test-subscriptions
          (lambda ()
            (define resp (thsl-src! "tests/critical-review-48-auth-api-tests.tesl" 268 (list) (lambda () (dispatch-api-test-request R48AuthServer 'post (list "triple-conj") #:cookie "user=alice" #:headers (hash) #:body (hash (string->symbol "value") 100) #:capabilities '()))))
  ...
  (test-case "inline conj: 50 tripled"
    (call-with-fresh-memory-db '()
      (lambda ()
        (call-with-api-test-subscriptions
          (lambda ()
            (define resp (thsl-src! "tests/critical-review-48-auth-api-tests.tesl" 273 (list) (lambda () (dispatch-api-test-request R48AuthServer 'post (list "inline-conj") #:cookie "user=bob" #:headers (hash) #:body (hash (string->symbol "value") 50) #:capabilities '()))))
  ...
  (test-case "inline conj: rejects 0"
    (call-with-fresh-memory-db '()
      (lambda ()
        (call-with-api-test-subscriptions
          (lambda ()
            (define resp (thsl-src! "tests/critical-review-48-auth-api-tests.tesl" 279 (list) (lambda () (dispatch-api-test-request R48AuthServer 'post (list "inline-conj") #:cookie "user=bob" #:headers (hash) #:body (hash (string->symbol "value") 0) #:capabilities '()))))
  ...
  (test-case "checkedAuth: valid user passes"
    (call-with-fresh-memory-db '()
      (lambda ()
        (call-with-api-test-subscriptions
          (lambda ()
            (define resp (thsl-src! "tests/critical-review-48-auth-api-tests.tesl" 288 (list) (lambda () (dispatch-api-test-request R48AuthServer 'get (list "whoami-checked") #:cookie "user=alice" #:headers (hash) #:capabilities '()))))
  ...
  (test-case "checkedAuth: empty cookie rejected"
    (call-with-fresh-memory-db '()
      (lambda ()
        (call-with-api-test-subscriptions
          (lambda ()
            (define resp (thsl-src! "tests/critical-review-48-auth-api-tests.tesl" 294 (list) (lambda () (dispatch-api-test-request R48AuthServer 'get (list "whoami-checked") #:cookie "user=" #:headers (hash) #:capabilities '()))))
  ...
  (test-case "checkedAuth: no cookie 401"
    (call-with-fresh-memory-db '()
      (lambda ()
        (call-with-api-test-subscriptions
          (lambda ()
            (define resp (thsl-src! "tests/critical-review-48-auth-api-tests.tesl" 299 (list) (lambda () (dispatch-api-test-request R48AuthServer 'get (list "whoami-checked") #:headers (hash) #:capabilities '()))))
  ...
  (test-case "adminAuth: admin user passes"
    (call-with-fresh-memory-db '()
      (lambda ()
        (call-with-api-test-subscriptions
          (lambda ()
            (define resp (thsl-src! "tests/critical-review-48-auth-api-tests.tesl" 304 (list) (lambda () (dispatch-api-test-request R48AuthServer 'get (list "whoami-admin") #:cookie "user=admin_alice" #:headers (hash) #:capabilities '()))))
  ...
  (test-case "adminAuth: non-admin rejected"
    (call-with-fresh-memory-db '()
      (lambda ()
        (call-with-api-test-subscriptions
          (lambda ()
            (define resp (thsl-src! "tests/critical-review-48-auth-api-tests.tesl" 310 (list) (lambda () (dispatch-api-test-request R48AuthServer 'get (list "whoami-admin") #:cookie "user=alice" #:headers (hash) #:capabilities '()))))
  ...
  (test-case "adminAuth: no cookie 401"
    (call-with-fresh-memory-db '()
      (lambda ()
        (call-with-api-test-subscriptions
          (lambda ()
            (define resp (thsl-src! "tests/critical-review-48-auth-api-tests.tesl" 315 (list) (lambda () (dispatch-api-test-request R48AuthServer 'get (list "whoami-admin") #:headers (hash) #:capabilities '()))))
  ...
  (test-case "conjAuth: user+session passes"
    (call-with-fresh-memory-db '()
      (lambda ()
        (call-with-api-test-subscriptions
          (lambda ()
            (define resp (thsl-src! "tests/critical-review-48-auth-api-tests.tesl" 324 (list) (lambda () (dispatch-api-test-request R48ConjAuthServer 'get (list "conj-whoami") #:cookie "user=alice; session=abc123" #:headers (hash) #:capabilities '()))))
  ...
  (test-case "conjAuth: missing session 401"
    (call-with-fresh-memory-db '()
      (lambda ()
        (call-with-api-test-subscriptions
          (lambda ()
            (define resp (thsl-src! "tests/critical-review-48-auth-api-tests.tesl" 330 (list) (lambda () (dispatch-api-test-request R48ConjAuthServer 'get (list "conj-whoami") #:cookie "user=alice" #:headers (hash) #:capabilities '()))))
  ...
  (test-case "conjAuth: no cookie 401"
    (call-with-fresh-memory-db '()
      (lambda ()
        (call-with-api-test-subscriptions
          (lambda ()
            (define resp (thsl-src! "tests/critical-review-48-auth-api-tests.tesl" 335 (list) (lambda () (dispatch-api-test-request R48ConjAuthServer 'get (list "conj-whoami") #:headers (hash) #:capabilities '()))))
  ...
  (test-case "conjManual: user+session passes"
    (call-with-fresh-memory-db '()
      (lambda ()
        (call-with-api-test-subscriptions
          (lambda ()
            (define resp (thsl-src! "tests/critical-review-48-auth-api-tests.tesl" 385 (list) (lambda () (dispatch-api-test-request R48ConjInAuthServer 'get (list "conj-manual") #:cookie "user=alice; session=abc" #:headers (hash) #:capabilities '()))))
  ...
  (test-case "conjManual: missing session 401"
    (call-with-fresh-memory-db '()
      (lambda ()
        (call-with-api-test-subscriptions
          (lambda ()
            (define resp (thsl-src! "tests/critical-review-48-auth-api-tests.tesl" 391 (list) (lambda () (dispatch-api-test-request R48ConjInAuthServer 'get (list "conj-manual") #:cookie "user=alice" #:headers (hash) #:capabilities '()))))
  ...
  (test-case "conjManual: no cookie 401"
    (call-with-fresh-memory-db '()
      (lambda ()
        (call-with-api-test-subscriptions
          (lambda ()
            (define resp (thsl-src! "tests/critical-review-48-auth-api-tests.tesl" 396 (list) (lambda () (dispatch-api-test-request R48ConjInAuthServer 'get (list "conj-manual") #:headers (hash) #:capabilities '()))))
  ...
  (test-case "conjCheck: admin passes"
    (call-with-fresh-memory-db '()
      (lambda ()
        (call-with-api-test-subscriptions
          (lambda ()
            (define resp (thsl-src! "tests/critical-review-48-auth-api-tests.tesl" 401 (list) (lambda () (dispatch-api-test-request R48ConjInAuthServer 'get (list "conj-check") #:cookie "user=admin_bob" #:headers (hash) #:capabilities '()))))
  ...
  (test-case "conjCheck: non-admin 403"
    (call-with-fresh-memory-db '()
      (lambda ()
        (call-with-api-test-subscriptions
          (lambda ()
            (define resp (thsl-src! "tests/critical-review-48-auth-api-tests.tesl" 407 (list) (lambda () (dispatch-api-test-request R48ConjInAuthServer 'get (list "conj-check") #:cookie "user=bob" #:headers (hash) #:capabilities '()))))
  ...
  (test-case "conjCheck: no cookie 401"
    (call-with-fresh-memory-db '()
      (lambda ()
        (call-with-api-test-subscriptions
          (lambda ()
            (define resp (thsl-src! "tests/critical-review-48-auth-api-tests.tesl" 412 (list) (lambda () (dispatch-api-test-request R48ConjInAuthServer 'get (list "conj-check") #:headers (hash) #:capabilities '()))))
