    ...
    (call-with-fresh-memory-db (list PathDb)
      (lambda ()
        (call-with-api-test-subscriptions
          (lambda ()
            (define r (thsl-src! "tests/api-test-computed-path-tests.tesl" 122 (list) (lambda () (dispatch-api-test-request PathServer 'get (list "things" "7") #:headers (tesl-hash) #:capabilities '()))))
      ...
      (lambda ()
        (call-with-api-test-subscriptions
          (lambda ()
            ...
            (define r (thsl-src! "tests/api-test-computed-path-tests.tesl" 131 (list (cons 'p p)) (lambda () (dispatch-api-test-request PathServer 'get p #:headers (tesl-hash) #:capabilities '()))))
      ...
      (lambda ()
        (call-with-api-test-subscriptions
          (lambda ()
            ...
            (define r (thsl-src! "tests/api-test-computed-path-tests.tesl" 138 (list (cons 'id id)) (lambda () (dispatch-api-test-request PathServer 'get (string-append (api-test-string-fragment "/things/") (api-test-string-fragment id)) #:headers (tesl-hash) #:capabilities '()))))
      ...
      (lambda ()
        (call-with-api-test-subscriptions
          (lambda ()
            ...
            (define r (thsl-src! "tests/api-test-computed-path-tests.tesl" 145 (list (cons 'id id)) (lambda () (dispatch-api-test-request PathServer 'get (format "/things/~a" (tesl-display-val id)) #:headers (tesl-hash) #:capabilities '()))))
  ...
  (test-case "a path built from a previous response's body routes"
    (call-with-fresh-memory-db (list PathDb)
      (lambda ()
        (call-with-api-test-subscriptions
          (lambda ()
            (define created (thsl-src! "tests/api-test-computed-path-tests.tesl" 153 (list) (lambda () (dispatch-api-test-request PathServer 'post (list "things") #:headers (tesl-hash) #:capabilities '()))))
  ...
  (test-case "a path built from a let-bound response field routes"
    (call-with-fresh-memory-db (list PathDb)
      (lambda ()
        (call-with-api-test-subscriptions
          (lambda ()
            (define created (thsl-src! "tests/api-test-computed-path-tests.tesl" 163 (list) (lambda () (dispatch-api-test-request PathServer 'post (list "things") #:headers (tesl-hash) #:capabilities '()))))
            ...
            (define r (thsl-src! "tests/api-test-computed-path-tests.tesl" 165 (list (cons 'id id) (cons 'created created)) (lambda () (dispatch-api-test-request PathServer 'get (string-append (api-test-string-fragment "/things/") (api-test-string-fragment id)) #:headers (tesl-hash) #:capabilities '()))))
  ...
  (test-case "a literal path keeps its query string"
    (call-with-fresh-memory-db (list PathDb)
      (lambda ()
        (call-with-api-test-subscriptions
          (lambda ()
            (define r (thsl-src! "tests/api-test-computed-path-tests.tesl" 173 (list) (lambda () (dispatch-api-test-request PathServer 'get (list "search") #:query "q=widgets" #:headers (tesl-hash) #:capabilities '()))))
      ...
      (lambda ()
        (call-with-api-test-subscriptions
          (lambda ()
            ...
            (define r (thsl-src! "tests/api-test-computed-path-tests.tesl" 180 (list (cons 'p p)) (lambda () (dispatch-api-test-request PathServer 'get p #:headers (tesl-hash) #:capabilities '()))))
      ...
      (lambda ()
        (call-with-api-test-subscriptions
          (lambda ()
            ...
            (define r (thsl-src! "tests/api-test-computed-path-tests.tesl" 187 (list (cons 'term term)) (lambda () (dispatch-api-test-request PathServer 'get (string-append (api-test-string-fragment "/search?q=") (api-test-string-fragment term)) #:headers (tesl-hash) #:capabilities '()))))
      ...
      (lambda ()
        (call-with-api-test-subscriptions
          (lambda ()
            ...
            (define r (thsl-src! "tests/api-test-computed-path-tests.tesl" 194 (list (cons 'p p)) (lambda () (dispatch-api-test-request PathServer 'get p #:headers (tesl-hash) #:capabilities '()))))
      ...
      (lambda ()
        (call-with-api-test-subscriptions
          (lambda ()
            ...
            (define r (thsl-src! "tests/api-test-computed-path-tests.tesl" 202 (list (cons 'p p)) (lambda () (dispatch-api-test-request PathServer 'get p #:headers (tesl-hash) #:capabilities '()))))
      ...
      (lambda ()
        (call-with-api-test-subscriptions
          (lambda ()
            ...
            (define r (thsl-src! "tests/api-test-computed-path-tests.tesl" 210 (list (cons 'p p)) (lambda () (dispatch-api-test-request PathServer 'get p #:headers (tesl-hash) #:capabilities '()))))
        ...
        (call-with-api-test-subscriptions
          (lambda ()
            (with-capabilities (pubsub)
              (define stream (thsl-src! "tests/api-test-computed-path-tests.tesl" 218 (list) (lambda () (subscribe PathServer-sse-routes (list "events" "topic-1") #:headers (tesl-hash) #:name "/events/topic-1"))))
              (define r (thsl-src! "tests/api-test-computed-path-tests.tesl" 219 (list (cons 'stream stream)) (lambda () (dispatch-api-test-request PathServer 'post (list "notify" "topic-1") #:headers (tesl-hash) #:capabilities (list pubsub)))))
              ...
              (check-true (raw-value (thsl-src! "tests/api-test-computed-path-tests.tesl" 223 (list (cons 'events events) (cons 'r r) (cons 'stream stream)) (lambda () (includesWhere (tesl-hash 'message "notice-topic-1") (raw-value events))))))
            )
          ))
      ))
  )
        ...
        (call-with-api-test-subscriptions
          (lambda ()
            (with-capabilities (pubsub)
              ...
              (define stream (thsl-src! "tests/api-test-computed-path-tests.tesl" 228 (list (cons 'topic topic)) (lambda () (subscribe PathServer-sse-routes (string-append (api-test-string-fragment "/events/") (api-test-string-fragment topic)) #:headers (tesl-hash) #:name ""))))
              (define r (thsl-src! "tests/api-test-computed-path-tests.tesl" 229 (list (cons 'stream stream) (cons 'topic topic)) (lambda () (dispatch-api-test-request PathServer 'post (string-append (api-test-string-fragment "/notify/") (api-test-string-fragment topic)) #:headers (tesl-hash) #:capabilities (list pubsub)))))
              ...
              (check-true (raw-value (thsl-src! "tests/api-test-computed-path-tests.tesl" 233 (list (cons 'events events) (cons 'r r) (cons 'stream stream) (cons 'topic topic)) (lambda () (includesWhere (tesl-hash 'message "notice-topic-2") (raw-value events))))))
            )
          ))
      ))
  )
