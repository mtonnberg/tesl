  ...
  (define b1-module-path
    (compile-tesl-source
     (string-append
      ...
      "  n\n"
      "fn getValue(n: Int ::: Positive n) -> Int =\n"
      "  n\n"
      "fn runB1(n: Int) -> Int =\n"
      "  let p = provePositive n\n"
  ...
  (define b2-module-path
    (compile-tesl-source
     (string-append
      ...
      "  n\n"
      "fn getValue(n: Int ::: Positive n && Small n) -> Int =\n"
      "  n\n"
      "fn runB2(n: Int) -> Int =\n"
  ...
  (define b4-module-path
    (compile-tesl-source
     (string-append
      ...
      "fn make(n: Int ::: Positive n, user: String ::: Admin user) -> Int ? Positive ::: Admin user =\n"
      "  n ::: detachFact user\n"
      "fn useResult(result: Int ::: Positive result && Admin user, user: String ::: Admin user) -> Int =\n"
      "  result\n"
  ...
  (define b9-module-path
    (compile-tesl-source
     (string-append
      ...
      "  let p = provePositive n\n"
      "  n ::: p\n"
      "fn requiresPackedProof(result: Int ::: Positive result, dummy: String) -> Int =\n"
      "  result\n"
      "fn runB9(n: Int) -> Int =\n"
