...
(define-checker
  ...
  (thsl-src! "tests/server-tools-tests.tesl" 73 (list (cons 'text *text)) (lambda () (if (tesl-le? (raw-value (tesl_import_String_length *text)) 20) (accept (TextSafe text) #:value *text) (reject "Text too long" #:http-code 400)))))
