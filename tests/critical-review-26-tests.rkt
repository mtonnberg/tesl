...
(define-checker
  ...
  (thsl-src! "tests/critical-review-26-tests.tesl" 107 (list (cons 'n *n)) (lambda () (if (tesl-gt? *n 0) (accept (Positive1 n) #:value *n) (reject "must be positive" #:http-code 400)))))
...
(define-checker
  ...
  (thsl-src! "tests/critical-review-26-tests.tesl" 149 (list (cons 'n *n)) (lambda () (if (tesl-gt? *n 0) (accept (PositiveA n) #:value *n) (reject "must be > 0" #:http-code 400)))))
...
(define-checker
  ...
  (thsl-src! "tests/critical-review-26-tests.tesl" 190 (list (cons 'n *n)) (lambda () (if (tesl-ge? *n 0) (accept (NonNeg n) #:value *n) (reject "must be >= 0" #:http-code 400)))))
...
(define/pow
  ...
  #:returns Boolean
  (thsl-src! "tests/critical-review-26-tests.tesl" 328 (list (cons 'a *a) (cons 'b *b)) (lambda () (tesl-gt? (raw-value (myIntVal a)) (raw-value (myIntVal b))))))

(define/pow
  (myIntSort [a : MyInt] [b : MyInt] [c : MyInt])
  #:returns MyInt
  (let ([av (thsl-src! "tests/critical-review-26-tests.tesl" 331 (list (cons 'a *a) (cons 'b *b) (cons 'c *c)) (lambda () (myIntVal a)))]) (let ([bv (thsl-src! "tests/critical-review-26-tests.tesl" 332 (list (cons 'av *av) (cons 'a *a) (cons 'b *b) (cons 'c *c)) (lambda () (myIntVal b)))]) (let ([cv (thsl-src! "tests/critical-review-26-tests.tesl" 333 (list (cons 'bv *bv) (cons 'av *av) (cons 'a *a) (cons 'b *b) (cons 'c *c)) (lambda () (myIntVal c)))]) (thsl-src! "tests/critical-review-26-tests.tesl" 334 (list (cons 'cv *cv) (cons 'bv *bv) (cons 'av *av) (cons 'a *a) (cons 'b *b) (cons 'c *c)) (lambda () (if (and (tesl-le? (raw-value av) (raw-value bv)) (tesl-le? (raw-value bv) (raw-value cv))) *b (if (and (tesl-le? (raw-value av) (raw-value cv)) (tesl-le? (raw-value cv) (raw-value bv))) *c *a))))))))

(define-checker
  (checkA4 [n : Integer])
  #:returns [n : Integer ::: (FactA n)]
  (thsl-src! "tests/critical-review-26-tests.tesl" 373 (list (cons 'n *n)) (lambda () (if (tesl-gt? *n 0) (accept (FactA n) #:value *n) (reject "FactA" #:http-code 400)))))

(define-checker
  (checkB4 [n : Integer])
  #:returns [n : Integer ::: (FactB n)]
  (thsl-src! "tests/critical-review-26-tests.tesl" 379 (list (cons 'n *n)) (lambda () (if (tesl-lt? *n 100) (accept (FactB n) #:value *n) (reject "FactB" #:http-code 400)))))
...
(define-checker
  ...
  (thsl-src! "tests/critical-review-26-tests.tesl" 404 (list (cons 'n *n)) (lambda () (if (tesl-gt? *n 0) (if (tesl-lt? *n 100) (if (not (tesl-equal? *n 13)) (if (tesl-equal? (remainder *n 2) 0) (accept ((FactA n) && ((FactB n) && ((FactC n) && (FactD n)))) #:value *n) (reject "FactD: must be even" #:http-code 400)) (reject "FactC: 13 is unlucky" #:http-code 400)) (reject "FactB: must be < 100" #:http-code 400)) (reject "FactA: must be > 0" #:http-code 400)))))
...
(define/pow
  (intEdge [n : Integer])
  #:returns Integer
  (thsl-src! "tests/critical-review-26-tests.tesl" 506 (list (cons 'n *n)) (lambda () (if (tesl-gt? *n 0) (raw-value 1) (if (tesl-lt? *n 0) (raw-value -1) (raw-value 0))))))

(define-checker
  (checkValidName [s : String])
  #:returns [s : String ::: (ValidName s)]
  (thsl-src! "tests/critical-review-26-tests.tesl" 546 (list (cons 's *s)) (lambda () (if (and (tesl-ge? (raw-value (tesl_import_String_length *s)) 2) (tesl-le? (raw-value (tesl_import_String_length *s)) 50)) (accept (ValidName s) #:value *s) (reject "name must be 2-50 chars" #:http-code 400)))))
...
(define/pow
  (isEven2 [n : Integer])
  #:returns Boolean
  (thsl-src! "tests/critical-review-26-tests.tesl" 690 (list (cons 'n *n)) (lambda () (if (tesl-equal? *n 0) (raw-value #t) (raw-value (isOdd2 (- *n 1)))))))

(define/pow
  (isOdd2 [n : Integer])
  #:returns Boolean
  (thsl-src! "tests/critical-review-26-tests.tesl" 696 (list (cons 'n *n)) (lambda () (if (tesl-equal? *n 0) (raw-value #f) (raw-value (isEven2 (- *n 1)))))))

(define/pow
  (doubleAndFilter [xs : (List Integer)])
  #:returns (List Integer)
  (thsl-src! "tests/critical-review-26-tests.tesl" 731 (list (cons 'xs *xs)) (lambda () (tesl_import_List_filterCheck checkPositive1 *xs))))

(define/pow
  (countProven [xs : (List Integer)])
  #:returns Integer
  (let ([filtered (thsl-src! "tests/critical-review-26-tests.tesl" 734 (list (cons 'xs *xs)) (lambda () (doubleAndFilter xs)))]) (thsl-src! "tests/critical-review-26-tests.tesl" 735 (list (cons 'filtered *filtered) (cons 'xs *xs)) (lambda () (raw-value (tesl_import_List_length (raw-value filtered)))))))

(define/pow
  (roundTripProof [n : Integer])
  #:returns Integer
  (thsl-src! "tests/critical-review-26-tests.tesl" 754 (list (cons 'n *n)) (lambda () (let/check ([tesl-checked-15 (checkPositiveA n)]) (let ([validated tesl-checked-15]) (let ([tesl-proof-binding-16 validated]) (let ([raw (forget-proof tesl-proof-binding-16)] [proof (detach-all-proof tesl-proof-binding-16)]) (let ([reattached (attach-proof raw proof)]) (raw-value (requiresPositiveA reattached))))))))))
...
(define-checker
  ...
  (thsl-src! "tests/critical-review-26-tests.tesl" 785 (list (cons 'raw *raw)) (lambda () (if (and (raw-value (tesl_import_String_contains *raw "@")) (tesl-ge? (raw-value (tesl_import_String_length *raw)) 5)) (let ([e (raw-value (Email *raw))]) (accept (ValidEmail e) #:value *e)) (reject "invalid email" #:http-code 400)))))

(define/pow
  (requiresEmail2 [e : Email ::: (ValidEmail e)])
  #:returns String
  (thsl-src! "tests/critical-review-26-tests.tesl" 792 (list (cons 'e *e)) (lambda () "email ok")))

(define-checker
  (checkPos [n : Integer])
  #:returns [n : Integer ::: (PosC n)]
  (thsl-src! "tests/critical-review-26-tests.tesl" 821 (list (cons 'n *n)) (lambda () (if (tesl-gt? *n 0) (accept (PosC n) #:value *n) (reject "not positive" #:http-code 400)))))

(define-checker
  (checkSmallN [n : Integer])
  #:returns [n : Integer ::: (SmallC n)]
  (thsl-src! "tests/critical-review-26-tests.tesl" 827 (list (cons 'n *n)) (lambda () (if (tesl-lt? *n 50) (accept (SmallC n) #:value *n) (reject "not small" #:http-code 400)))))

(define/pow
  (checkPosAndSmall2 [n : Integer])
  #:returns String
  (thsl-src! "tests/critical-review-26-tests.tesl" 833 (list (cons 'n *n)) (lambda () (let/check ([tesl-checked-17 ((check-and checkPos checkSmallN) n)]) (let ([result tesl-checked-17]) (format "ok: ~a" (tesl-display-val *result)))))))

(define/pow
  (lookupWithDefault [items : (List Integer)] [target : Integer])
  #:returns Integer
  (let ([found (thsl-src! "tests/critical-review-26-tests.tesl" 866 (list (cons 'items *items) (cons 'target *target)) (lambda () (raw-value (tesl_import_List_head (raw-value (tesl_import_List_filter (let () (define/pow (tesl-lambda-18 [n : Integer]) #:returns Boolean (tesl-equal? *n *target)) tesl-lambda-18) *items))))))]) (thsl-src-control! "tests/critical-review-26-tests.tesl" 867 (list (cons 'found *found) (cons 'items *items) (cons 'target *target)) (lambda () (let ([tesl-case-19 (raw-value found)]) (cond [(and (adt-value? *tesl-case-19) (eq? (adt-value-variant *tesl-case-19) 'Nothing)) (thsl-src! "tests/critical-review-26-tests.tesl" 868 (list) (lambda () (raw-value -999)))] [(and (adt-value? *tesl-case-19) (eq? (adt-value-variant *tesl-case-19) 'Something)) (let ([val (hash-ref (adt-value-fields *tesl-case-19) 'value)]) (thsl-src! "tests/critical-review-26-tests.tesl" 869 (list (cons 'val val)) (lambda () *val)))]))))))

(define/pow
  (aVeryLongFunctionNameThatTestsIfTheLexerHandlesLongIdentifiersCorrectly [n : Integer])
  #:returns Integer
  (thsl-src! "tests/critical-review-26-tests.tesl" 893 (list (cons 'n *n)) (lambda () (+ *n 1))))

(define/pow
  (applyCheckToList [xs : (List Integer)])
  #:returns (List Integer)
  (thsl-src! "tests/critical-review-26-tests.tesl" 909 (list (cons 'xs *xs)) (lambda () (tesl_import_List_filterCheck checkPositive1 *xs))))

(define/pow
  (applyLambdaToFiltered [xs : (List Integer)])
  #:returns Integer
  (let ([filtered (thsl-src! "tests/critical-review-26-tests.tesl" 912 (list (cons 'xs *xs)) (lambda () (applyCheckToList xs)))]) (thsl-src! "tests/critical-review-26-tests.tesl" 913 (list (cons 'filtered *filtered) (cons 'xs *xs)) (lambda () (raw-value (tesl_import_List_foldl (let () (define/pow (tesl-lambda-20 [acc : Integer] [n : Integer]) #:returns Integer (+ *acc *n)) tesl-lambda-20) 0 (raw-value filtered)))))))

(define-checker
  (checkSafeTitle [s : String])
  #:returns [s : String ::: (SafeTitle s)]
  (thsl-src! "tests/critical-review-26-tests.tesl" 935 (list (cons 's *s)) (lambda () (if (and (tesl-ge? (raw-value (tesl_import_String_length *s)) 3) (tesl-le? (raw-value (tesl_import_String_length *s)) 100)) (accept (SafeTitle s) #:value *s) (reject "title must be 3-100 chars" #:http-code 400)))))
...
(define/pow
  ...
  #:returns SafeRecord
  (thsl-src! "tests/critical-review-26-tests.tesl" 945 (list (cons 'raw *raw)) (lambda () (let/check ([tesl-checked-21 (checkSafeTitle raw)]) (let ([t tesl-checked-21]) (SafeRecord #:title t))))))

(define/pow
  (requiresSafeRecord [r : SafeRecord])
  #:returns String
  (thsl-src! "tests/critical-review-26-tests.tesl" 949 (list (cons 'r *r)) (lambda () (tesl-dot/runtime r 'title 'SafeRecord))))

(define/pow
  (parsePositiveInt [s : String])
  #:returns (Result Integer String)
  (thsl-src! "tests/critical-review-26-tests.tesl" 970 (list (cons 's *s)) (lambda () (if (tesl_import_String_isEmpty *s) (raw-value (raw-value (Err "empty input"))) (let ([n (tesl_import_String_length *s)]) (if (tesl-gt? (raw-value n) 3) (raw-value (raw-value (Err "too long to be an int"))) (raw-value (raw-value (Ok (raw-value n))))))))))

(define/pow
  (parseIntOk [s : String])
  #:returns Integer
  (thsl-src-control! "tests/critical-review-26-tests.tesl" 980 (list (cons 's *s)) (lambda () (let ([tesl-case-22 (raw-value (parsePositiveInt s))]) (cond [(and (adt-value? *tesl-case-22) (eq? (adt-value-variant *tesl-case-22) 'Ok)) (let ([n (hash-ref (adt-value-fields *tesl-case-22) 'value)]) (thsl-src! "tests/critical-review-26-tests.tesl" 981 (list (cons 'n n)) (lambda () *n)))] [(and (adt-value? *tesl-case-22) (eq? (adt-value-variant *tesl-case-22) 'Err)) (thsl-src! "tests/critical-review-26-tests.tesl" 982 (list) (lambda () (raw-value -1)))])))))

(define/pow
  (parseIntErr [s : String])
  #:returns Boolean
  (thsl-src-control! "tests/critical-review-26-tests.tesl" 985 (list (cons 's *s)) (lambda () (let ([tesl-case-23 (raw-value (parsePositiveInt s))]) (cond [(and (adt-value? *tesl-case-23) (eq? (adt-value-variant *tesl-case-23) 'Err)) (thsl-src! "tests/critical-review-26-tests.tesl" 986 (list) (lambda () (raw-value #t)))] [(and (adt-value? *tesl-case-23) (eq? (adt-value-variant *tesl-case-23) 'Ok)) (thsl-src! "tests/critical-review-26-tests.tesl" 987 (list) (lambda () (raw-value #f)))])))))

(define/pow
  (forgetOnlyLeft [n : Integer])
  #:returns Integer
  (thsl-src! "tests/critical-review-26-tests.tesl" 1011 (list (cons 'n *n)) (lambda () (let/check ([tesl-checked-24 (checkPositiveA n)]) (let ([validated tesl-checked-24]) (let ([tesl-proof-binding-25 validated]) (let ([_ (forget-proof tesl-proof-binding-25)] [proof (detach-all-proof tesl-proof-binding-25)]) (let ([fresh n]) (let ([reattached (attach-proof fresh proof)]) (raw-value (requiresPositiveA reattached)))))))))))

(define-trusted
  (establishEven [n : Integer])
  #:returns (Maybe (Fact (EvenFact n)))
  (thsl-src! "tests/critical-review-26-tests.tesl" 1036 (list (cons 'n *n)) (lambda () (if (tesl-equal? (remainder *n 2) 0) (Something (trusted-proof (EvenFact n))) Nothing))))

(define/pow
  (requiresEven [n : Integer ::: (EvenFact n)])
  #:returns String
  (thsl-src! "tests/critical-review-26-tests.tesl" 1041 (list (cons 'n *n)) (lambda () (format "even: ~a" (tesl-display-val *n)))))

(define/pow
  (checkOrEstablish [n : Integer])
  #:returns String
  (let ([mProof (thsl-src! "tests/critical-review-26-tests.tesl" 1044 (list (cons 'n *n)) (lambda () (establishEven n)))]) (thsl-src-control! "tests/critical-review-26-tests.tesl" 1045 (list (cons 'mProof *mProof) (cons 'n *n)) (lambda () (let ([tesl-case-26 (raw-value mProof)]) (cond [(and (adt-value? *tesl-case-26) (eq? (adt-value-variant *tesl-case-26) 'Nothing)) (thsl-src! "tests/critical-review-26-tests.tesl" 1046 (list) (lambda () (raw-value "not even")))] [(and (adt-value? *tesl-case-26) (eq? (adt-value-variant *tesl-case-26) 'Something)) (let ([p (hash-ref (adt-value-fields *tesl-case-26) 'value)]) (thsl-src! "tests/critical-review-26-tests.tesl" 1047 (list (cons 'p p)) (lambda () (raw-value (requiresEven (attach-proof n p))))))]))))))
...
(define/pow
  ...
  #:returns Integer
  (thsl-src-control! "tests/critical-review-26-tests.tesl" 1075 (list (cons 'w *w) (cons 'threshold *threshold)) (lambda () (let ([tesl-case-27 *w]) (cond [(and (adt-value? *tesl-case-27) (eq? (adt-value-variant *tesl-case-27) 'Empty)) (thsl-src! "tests/critical-review-26-tests.tesl" 1076 (list) (lambda () (raw-value -1)))] [(and (and (adt-value? *tesl-case-27) (eq? (adt-value-variant *tesl-case-27) 'Wrap)) (let ([value (hash-ref (adt-value-fields *tesl-case-27) 'value)]) (tesl-gt? *value *threshold))) (let ([value (hash-ref (adt-value-fields *tesl-case-27) 'value)]) (thsl-src! "tests/critical-review-26-tests.tesl" 1077 (list (cons 'value value)) (lambda () *value)))] [(and (adt-value? *tesl-case-27) (eq? (adt-value-variant *tesl-case-27) 'Wrap)) (thsl-src! "tests/critical-review-26-tests.tesl" 1078 (list) (lambda () (raw-value 0)))])))))
...
(define/pow
  (treeSum [t : MathTree])
  #:returns Integer
  (thsl-src-control! "tests/critical-review-26-tests.tesl" 1110 (list (cons 't *t)) (lambda () (let ([tesl-case-28 *t]) (cond [(and (adt-value? *tesl-case-28) (eq? (adt-value-variant *tesl-case-28) 'Leaf)) (let ([value (hash-ref (adt-value-fields *tesl-case-28) 'value)]) (thsl-src! "tests/critical-review-26-tests.tesl" 1111 (list (cons 'value value)) (lambda () *value)))] [(and (adt-value? *tesl-case-28) (eq? (adt-value-variant *tesl-case-28) 'Branch)) (let ([left (hash-ref (adt-value-fields *tesl-case-28) 'left)]) (let ([right (hash-ref (adt-value-fields *tesl-case-28) 'right)]) (thsl-src! "tests/critical-review-26-tests.tesl" 1112 (list (cons 'left left) (cons 'right right)) (lambda () (raw-value (+ (raw-value (treeSum *left)) (raw-value (treeSum *right))))))))])))))

(define-checker
  (checkInRange3 [lo : Integer] [hi : Integer] [n : Integer])
  #:returns [n : Integer ::: (InRange3 lo hi n)]
  (thsl-src! "tests/critical-review-26-tests.tesl" 1151 (list (cons 'lo *lo) (cons 'hi *hi) (cons 'n *n)) (lambda () (if (and (tesl-le? *lo *n) (tesl-le? *n *hi)) (accept (InRange3 lo hi n) #:value *n) (reject "out of range" #:http-code 400)))))

(define/pow
  (requiresInRange3 [lo : Integer] [hi : Integer] [n : Integer ::: (InRange3 lo hi n)])
  #:returns String
  (thsl-src! "tests/critical-review-26-tests.tesl" 1157 (list (cons 'lo *lo) (cons 'hi *hi) (cons 'n *n)) (lambda () (format "~a in [~a, ~a]" (tesl-display-val *n) (tesl-display-val *lo) (tesl-display-val *hi)))))

(define/pow
  (useInRange3 [lo : Integer] [hi : Integer] [n : Integer])
  #:returns String
  (thsl-src! "tests/critical-review-26-tests.tesl" 1160 (list (cons 'lo *lo) (cons 'hi *hi) (cons 'n *n)) (lambda () (let/check ([tesl-checked-29 (checkInRange3 lo hi n)]) (let ([v tesl-checked-29]) (raw-value (requiresInRange3 lo hi v)))))))

(define/pow
  (discardBothHalves [n : Integer])
  #:returns Integer
  (thsl-src! "tests/critical-review-26-tests.tesl" 1200 (list (cons 'n *n)) (lambda () (let/check ([tesl-checked-30 (checkPositiveA n)]) (let ([validated tesl-checked-30]) (let ([_ validated]) (+ *n 1)))))))
...
(module+ test
  ...
  (test-case "T14e: Float.sqrt of 0 is 0 (non-positive)"
    (call-with-fresh-memory-db '() (lambda ()
  (define zeroRaw (thsl-src! "tests/critical-review-26-tests.tesl" 669 (list) (lambda () 0.)))
  (define tesl-checked-31 (tesl_import_Float_requireNonNegative zeroRaw))
  (when (check-fail? tesl-checked-31)
    (raise-user-error 'tesl-test "unexpected failure in let zero: ~a" (check-fail-message tesl-checked-31)))
  (define zero tesl-checked-31)
  (check-equal? (raw-value (thsl-src! "tests/critical-review-26-tests.tesl" 671 (list (cons 'zero zero) (cons 'zeroRaw zeroRaw)) (lambda () (floatEdge (raw-value (tesl_import_Float_sqrt zero)))))) "non-positive")
    ))
  )

  (test-case "T14f: Float.sqrt of 4 is 2 (positive)"
    (call-with-fresh-memory-db '() (lambda ()
  (define fourRaw (thsl-src! "tests/critical-review-26-tests.tesl" 675 (list) (lambda () 4.)))
  (define tesl-checked-32 (tesl_import_Float_requireNonNegative fourRaw))
  (when (check-fail? tesl-checked-32)
    (raise-user-error 'tesl-test "unexpected failure in let four: ~a" (check-fail-message tesl-checked-32)))
  (define four tesl-checked-32)
  (check-equal? (raw-value (thsl-src! "tests/critical-review-26-tests.tesl" 677 (list (cons 'four four) (cons 'fourRaw fourRaw)) (lambda () (floatEdge (raw-value (tesl_import_Float_sqrt four)))))) "positive")
    ))
  )

  (test-case "T14g: Float.abs of negative is positive"
    (call-with-fresh-memory-db '() (lambda ()
  (check-equal? (raw-value (thsl-src! "tests/critical-review-26-tests.tesl" 681 (list) (lambda () (floatEdge (raw-value (tesl_import_Float_abs -5.)))))) "positive")
    ))
  )

  (test-case "T15a: 0 is even"
    (call-with-fresh-memory-db '() (lambda ()
  (check-equal? (raw-value (thsl-src! "tests/critical-review-26-tests.tesl" 702 (list) (lambda () (isEven2 0)))) #t)
    ))
  )

  (test-case "T15b: 1 is odd"
    (call-with-fresh-memory-db '() (lambda ()
  (check-equal? (raw-value (thsl-src! "tests/critical-review-26-tests.tesl" 706 (list) (lambda () (isOdd2 1)))) #t)
    ))
  )

  (test-case "T15c: 2 is even"
    (call-with-fresh-memory-db '() (lambda ()
  (check-equal? (raw-value (thsl-src! "tests/critical-review-26-tests.tesl" 710 (list) (lambda () (isEven2 2)))) #t)
    ))
  )

  (test-case "T15d: 7 is odd"
    (call-with-fresh-memory-db '() (lambda ()
  (check-equal? (raw-value (thsl-src! "tests/critical-review-26-tests.tesl" 714 (list) (lambda () (isOdd2 7)))) #t)
    ))
  )

  (test-case "T15e: 10 is even"
    (call-with-fresh-memory-db '() (lambda ()
  (check-equal? (raw-value (thsl-src! "tests/critical-review-26-tests.tesl" 718 (list) (lambda () (isEven2 10)))) #t)
    ))
  )

  (test-case "T15f: 0 is not odd"
    (call-with-fresh-memory-db '() (lambda ()
  (check-equal? (raw-value (thsl-src! "tests/critical-review-26-tests.tesl" 722 (list) (lambda () (isOdd2 0)))) #f)
    ))
  )

  (test-case "T16a: pipeline: filter then count"
    (call-with-fresh-memory-db '() (lambda ()
  (check-equal? (raw-value (thsl-src! "tests/critical-review-26-tests.tesl" 738 (list) (lambda () (countProven (list 1 -1 2 -2 3))))) 3)
    ))
  )

  (test-case "T16b: pipeline: all pass"
    (call-with-fresh-memory-db '() (lambda ()
  (check-equal? (raw-value (thsl-src! "tests/critical-review-26-tests.tesl" 742 (list) (lambda () (countProven (list 5 10 15))))) 3)
    ))
  )

  (test-case "T16c: pipeline: none pass"
    (call-with-fresh-memory-db '() (lambda ()
  (check-equal? (raw-value (thsl-src! "tests/critical-review-26-tests.tesl" 746 (list) (lambda () (countProven (list -1 -2 -3))))) 0)
    ))
  )

  (test-case "T17a: round-trip preserves value"
    (call-with-fresh-memory-db '() (lambda ()
  (check-equal? (raw-value (thsl-src! "tests/critical-review-26-tests.tesl" 760 (list) (lambda () (roundTripProof 7)))) 14)
    ))
  )

  (test-case "T17b: round-trip preserves behaviour"
    (call-with-fresh-memory-db '() (lambda ()
  (check-equal? (raw-value (thsl-src! "tests/critical-review-26-tests.tesl" 764 (list) (lambda () (roundTripProof 1)))) 2)
    ))
  )

  (test-case "T17c: round-trip fails for non-positive"
    (call-with-fresh-memory-db '() (lambda ()
  (let ([tesl-ef-result (with-handlers ([exn:fail? (lambda (e) 'tesl-exception)]) (thsl-src! "tests/critical-review-26-tests.tesl" 768 (list) (lambda ()
                          (roundTripProof 0))))])
    (check-true (or (eq? tesl-ef-result 'tesl-exception) (check-fail? tesl-ef-result))
  ...
  (test-case "T17d: round-trip with large value"
    (call-with-fresh-memory-db '() (lambda ()
  (check-equal? (raw-value (thsl-src! "tests/critical-review-26-tests.tesl" 772 (list) (lambda () (roundTripProof 500)))) 1000)
    ))
  )

  (test-case "T18a: valid email passes check"
    (call-with-fresh-memory-db '() (lambda ()
  (define tesl-checked-33 (checkEmail2 "a@b.com"))
  (when (check-fail? tesl-checked-33)
    (raise-user-error 'tesl-test "unexpected failure in let e: ~a" (check-fail-message tesl-checked-33)))
  (define e tesl-checked-33)
  (check-equal? (raw-value (thsl-src! "tests/critical-review-26-tests.tesl" 796 (list (cons 'e e)) (lambda () (requiresEmail2 e)))) "email ok")
    ))
  )

  (test-case "T18b: email without @ fails"
    (call-with-fresh-memory-db '() (lambda ()
  (let ([tesl-ef-result (with-handlers ([exn:fail? (lambda (e) 'tesl-exception)]) (thsl-src! "tests/critical-review-26-tests.tesl" 800 (list) (lambda ()
  ...
  (test-case "T18c: too-short email fails"
    (call-with-fresh-memory-db '() (lambda ()
  (let ([tesl-ef-result (with-handlers ([exn:fail? (lambda (e) 'tesl-exception)]) (thsl-src! "tests/critical-review-26-tests.tesl" 804 (list) (lambda ()
                          (checkEmail2 "a@b"))))])
    (check-true (or (eq? tesl-ef-result 'tesl-exception) (check-fail? tesl-ef-result))
  ...
  (test-case "T18d: exactly minimum length with @"
    (call-with-fresh-memory-db '() (lambda ()
  (define tesl-checked-34 (checkEmail2 "a@b.c"))
  ...
  (check-equal? (raw-value (thsl-src! "tests/critical-review-26-tests.tesl" 809 (list (cons 'e e)) (lambda () (requiresEmail2 e)))) "email ok")
    ))
  )

  (test-case "T19a: 5 is positive and small"
    (call-with-fresh-memory-db '() (lambda ()
  (check-equal? (raw-value (thsl-src! "tests/critical-review-26-tests.tesl" 837 (list) (lambda () (checkPosAndSmall2 5)))) "ok: 5")
    ))
  )

  (test-case "T19b: 0 is not positive \226\128\148 left fails"
    (call-with-fresh-memory-db '() (lambda ()
  (let ([tesl-ef-result (with-handlers ([exn:fail? (lambda (e) 'tesl-exception)]) (thsl-src! "tests/critical-review-26-tests.tesl" 841 (list) (lambda ()
                          (checkPosAndSmall2 0))))])
    (check-true (or (eq? tesl-ef-result 'tesl-exception) (check-fail? tesl-ef-result))
  ...
  (test-case "T19c: 50 is not small \226\128\148 right fails"
    (call-with-fresh-memory-db '() (lambda ()
  (let ([tesl-ef-result (with-handlers ([exn:fail? (lambda (e) 'tesl-exception)]) (thsl-src! "tests/critical-review-26-tests.tesl" 845 (list) (lambda ()
  ...
  (test-case "T19d: -10 fails both"
    (call-with-fresh-memory-db '() (lambda ()
  (let ([tesl-ef-result (with-handlers ([exn:fail? (lambda (e) 'tesl-exception)]) (thsl-src! "tests/critical-review-26-tests.tesl" 849 (list) (lambda ()
  ...
  (test-case "T19e: 49 is positive and small"
    (call-with-fresh-memory-db '() (lambda ()
  (check-equal? (raw-value (thsl-src! "tests/critical-review-26-tests.tesl" 853 (list) (lambda () (checkPosAndSmall2 49)))) "ok: 49")
    ))
  )

  (test-case "T19f: 1 is positive and small"
    (call-with-fresh-memory-db '() (lambda ()
  (check-equal? (raw-value (thsl-src! "tests/critical-review-26-tests.tesl" 857 (list) (lambda () (checkPosAndSmall2 1)))) "ok: 1")
    ))
  )

  (test-case "T20a: found returns value"
    (call-with-fresh-memory-db '() (lambda ()
  (check-equal? (raw-value (thsl-src! "tests/critical-review-26-tests.tesl" 872 (list) (lambda () (lookupWithDefault (list 1 2 3) 2)))) 2)
    ))
  )

  (test-case "T20b: not found returns -999"
    (call-with-fresh-memory-db '() (lambda ()
  (check-equal? (raw-value (thsl-src! "tests/critical-review-26-tests.tesl" 876 (list) (lambda () (lookupWithDefault (list 1 2 3) 9)))) -999)
    ))
  )

  (test-case "T20c: empty list returns -999"
    (call-with-fresh-memory-db '() (lambda ()
  (check-equal? (raw-value (thsl-src! "tests/critical-review-26-tests.tesl" 880 (list) (lambda () (lookupWithDefault (list) 1)))) -999)
    ))
  )

  (test-case "T20d: found first element"
    (call-with-fresh-memory-db '() (lambda ()
  (check-equal? (raw-value (thsl-src! "tests/critical-review-26-tests.tesl" 884 (list) (lambda () (lookupWithDefault (list 5 6 7) 5)))) 5)
    ))
  )

  (test-case "T21a: long name function works"
    (call-with-fresh-memory-db '() (lambda ()
  (check-equal? (raw-value (thsl-src! "tests/critical-review-26-tests.tesl" 896 (list) (lambda () (aVeryLongFunctionNameThatTestsIfTheLexerHandlesLongIdentifiersCorrectly 41)))) 42)
    ))
  )

  (test-case "T21b: long name with zero"
    (call-with-fresh-memory-db '() (lambda ()
  (check-equal? (raw-value (thsl-src! "tests/critical-review-26-tests.tesl" 900 (list) (lambda () (aVeryLongFunctionNameThatTestsIfTheLexerHandlesLongIdentifiersCorrectly 0)))) 1)
    ))
  )

  (test-case "T22a: lambda folds filtered list"
    (call-with-fresh-memory-db '() (lambda ()
  (check-equal? (raw-value (thsl-src! "tests/critical-review-26-tests.tesl" 916 (list) (lambda () (applyLambdaToFiltered (list 1 2 3 -1 -2))))) 6)
    ))
  )

  (test-case "T22b: lambda fold on empty after filter"
    (call-with-fresh-memory-db '() (lambda ()
  (check-equal? (raw-value (thsl-src! "tests/critical-review-26-tests.tesl" 920 (list) (lambda () (applyLambdaToFiltered (list -1 -2 -3))))) 0)
    ))
  )

  (test-case "T22c: lambda fold all positive"
    (call-with-fresh-memory-db '() (lambda ()
  (check-equal? (raw-value (thsl-src! "tests/critical-review-26-tests.tesl" 924 (list) (lambda () (applyLambdaToFiltered (list 10 20 30))))) 60)
    ))
  )

  (test-case "T23a: valid title creates record"
    (call-with-fresh-memory-db '() (lambda ()
  (define r (thsl-src! "tests/critical-review-26-tests.tesl" 952 (list) (lambda () (checkSafeRecord "Hello World"))))
  (check-equal? (raw-value (thsl-src! "tests/critical-review-26-tests.tesl" 953 (list (cons 'r r)) (lambda () (requiresSafeRecord r)))) "Hello World")
    ))
  )

  (test-case "T23b: too-short title fails"
    (call-with-fresh-memory-db '() (lambda ()
  (let ([tesl-ef-result (with-handlers ([exn:fail? (lambda (e) 'tesl-exception)]) (thsl-src! "tests/critical-review-26-tests.tesl" 957 (list) (lambda ()
                          (checkSafeRecord "Hi"))))])
    (check-true (or (eq? tesl-ef-result 'tesl-exception) (check-fail? tesl-ef-result))
  ...
  (test-case "T23c: exact min length creates record"
    (call-with-fresh-memory-db '() (lambda ()
  (define r (thsl-src! "tests/critical-review-26-tests.tesl" 961 (list) (lambda () (checkSafeRecord "ABC"))))
  (check-equal? (raw-value (thsl-src! "tests/critical-review-26-tests.tesl" 962 (list (cons 'r r)) (lambda () (requiresSafeRecord r)))) "ABC")
    ))
  )

  (test-case "T24a: Ok result returned for valid input"
    (call-with-fresh-memory-db '() (lambda ()
  (check-equal? (raw-value (thsl-src! "tests/critical-review-26-tests.tesl" 990 (list) (lambda () (parseIntOk "hi")))) 2)
    ))
  )

  (test-case "T24b: Err for empty input"
    (call-with-fresh-memory-db '() (lambda ()
  (check-equal? (raw-value (thsl-src! "tests/critical-review-26-tests.tesl" 994 (list) (lambda () (parseIntErr "")))) #t)
    ))
  )

  (test-case "T24c: Ok carries correct value"
    (call-with-fresh-memory-db '() (lambda ()
  (check-equal? (raw-value (thsl-src! "tests/critical-review-26-tests.tesl" 998 (list) (lambda () (parseIntOk "abc")))) 3)
    ))
  )

  (test-case "T24d: Err for too-long input"
    (call-with-fresh-memory-db '() (lambda ()
  (check-equal? (raw-value (thsl-src! "tests/critical-review-26-tests.tesl" 1002 (list) (lambda () (parseIntErr "toolong")))) #t)
    ))
  )

  (test-case "T25a: forget value, keep proof, reattach to same raw int"
    (call-with-fresh-memory-db '() (lambda ()
  (check-equal? (raw-value (thsl-src! "tests/critical-review-26-tests.tesl" 1018 (list) (lambda () (forgetOnlyLeft 8)))) 16)
    ))
  )

  (test-case "T25b: for value 1"
    (call-with-fresh-memory-db '() (lambda ()
  (check-equal? (raw-value (thsl-src! "tests/critical-review-26-tests.tesl" 1022 (list) (lambda () (forgetOnlyLeft 1)))) 2)
    ))
  )

  (test-case "T25c: non-positive fails at original check"
    (call-with-fresh-memory-db '() (lambda ()
  (let ([tesl-ef-result (with-handlers ([exn:fail? (lambda (e) 'tesl-exception)]) (thsl-src! "tests/critical-review-26-tests.tesl" 1026 (list) (lambda ()
                          (forgetOnlyLeft 0))))])
    (check-true (or (eq? tesl-ef-result 'tesl-exception) (check-fail? tesl-ef-result))
  ...
  (test-case "T26a: even number gets proof"
    (call-with-fresh-memory-db '() (lambda ()
  (check-equal? (raw-value (thsl-src! "tests/critical-review-26-tests.tesl" 1050 (list) (lambda () (checkOrEstablish 4)))) "even: 4")
    ))
  )

  (test-case "T26b: odd number gets Nothing"
    (call-with-fresh-memory-db '() (lambda ()
  (check-equal? (raw-value (thsl-src! "tests/critical-review-26-tests.tesl" 1054 (list) (lambda () (checkOrEstablish 3)))) "not even")
    ))
  )

  (test-case "T26c: zero is even"
    (call-with-fresh-memory-db '() (lambda ()
  (check-equal? (raw-value (thsl-src! "tests/critical-review-26-tests.tesl" 1058 (list) (lambda () (checkOrEstablish 0)))) "even: 0")
    ))
  )

  (test-case "T26d: negative even"
    (call-with-fresh-memory-db '() (lambda ()
  (check-equal? (raw-value (thsl-src! "tests/critical-review-26-tests.tesl" 1062 (list) (lambda () (checkOrEstablish -2)))) "even: -2")
    ))
  )

  (test-case "T27a: Empty returns -1"
    (call-with-fresh-memory-db '() (lambda ()
  (check-equal? (raw-value (thsl-src! "tests/critical-review-26-tests.tesl" 1081 (list) (lambda () (guardedProof Empty 10)))) -1)
    ))
  )

  (test-case "T27b: Wrap 15 with threshold 10 returns 15"
    (call-with-fresh-memory-db '() (lambda ()
  (check-equal? (raw-value (thsl-src! "tests/critical-review-26-tests.tesl" 1085 (list) (lambda () (guardedProof (Wrap 15) 10)))) 15)
    ))
  )

  (test-case "T27c: Wrap 5 with threshold 10 falls through to 0"
    (call-with-fresh-memory-db '() (lambda ()
  (check-equal? (raw-value (thsl-src! "tests/critical-review-26-tests.tesl" 1089 (list) (lambda () (guardedProof (Wrap 5) 10)))) 0)
    ))
  )

  (test-case "T27d: Wrap 10 with threshold 10 is NOT > 10, falls to 0"
    (call-with-fresh-memory-db '() (lambda ()
  (check-equal? (raw-value (thsl-src! "tests/critical-review-26-tests.tesl" 1093 (list) (lambda () (guardedProof (Wrap 10) 10)))) 0)
    ))
  )

  (test-case "T27e: Wrap 11 with threshold 10 is > 10"
    (call-with-fresh-memory-db '() (lambda ()
  (check-equal? (raw-value (thsl-src! "tests/critical-review-26-tests.tesl" 1097 (list) (lambda () (guardedProof (Wrap 11) 10)))) 11)
    ))
  )

  (test-case "T28a: single leaf"
    (call-with-fresh-memory-db '() (lambda ()
  (check-equal? (raw-value (thsl-src! "tests/critical-review-26-tests.tesl" 1115 (list) (lambda () (treeSum (Leaf 5))))) 5)
    ))
  )

  (test-case "T28b: two-leaf tree"
    (call-with-fresh-memory-db '() (lambda ()
  (define t (thsl-src! "tests/critical-review-26-tests.tesl" 1119 (list) (lambda () (raw-value (Branch (Leaf 3) (Leaf 4))))))
  (check-equal? (raw-value (thsl-src! "tests/critical-review-26-tests.tesl" 1120 (list (cons 't t)) (lambda () (treeSum t)))) 7)
    ))
  )

  (test-case "T28c: three-level tree"
    (call-with-fresh-memory-db '() (lambda ()
  (define t (thsl-src! "tests/critical-review-26-tests.tesl" 1124 (list) (lambda () (raw-value (Branch (Branch (Leaf 1) (Leaf 2)) (Branch (Leaf 3) (Leaf 4)))))))
  (check-equal? (raw-value (thsl-src! "tests/critical-review-26-tests.tesl" 1125 (list (cons 't t)) (lambda () (treeSum t)))) 10)
    ))
  )

  (test-case "T28d: unbalanced tree"
    (call-with-fresh-memory-db '() (lambda ()
  (define t (thsl-src! "tests/critical-review-26-tests.tesl" 1129 (list) (lambda () (raw-value (Branch (Leaf 10) (Branch (Leaf 1) (Branch (Leaf 2) (Leaf 3))))))))
  (check-equal? (raw-value (thsl-src! "tests/critical-review-26-tests.tesl" 1130 (list (cons 't t)) (lambda () (treeSum t)))) 16)
    ))
  )

  (test-case "T28e: all-zero leaves"
    (call-with-fresh-memory-db '() (lambda ()
  (define t (thsl-src! "tests/critical-review-26-tests.tesl" 1134 (list) (lambda () (raw-value (Branch (Leaf 0) (Branch (Leaf 0) (Leaf 0)))))))
  (check-equal? (raw-value (thsl-src! "tests/critical-review-26-tests.tesl" 1135 (list (cons 't t)) (lambda () (treeSum t)))) 0)
    ))
  )

  (test-case "T28f: negative leaves"
    (call-with-fresh-memory-db '() (lambda ()
  (define t (thsl-src! "tests/critical-review-26-tests.tesl" 1139 (list) (lambda () (raw-value (Branch (Leaf -1) (Leaf -2))))))
  (check-equal? (raw-value (thsl-src! "tests/critical-review-26-tests.tesl" 1140 (list (cons 't t)) (lambda () (treeSum t)))) -3)
    ))
  )

  (test-case "T29a: 5 in [1, 10]"
    (call-with-fresh-memory-db '() (lambda ()
  (check-equal? (raw-value (thsl-src! "tests/critical-review-26-tests.tesl" 1164 (list) (lambda () (useInRange3 1 10 5)))) "5 in [1, 10]")
    ))
  )

  (test-case "T29b: at lower bound"
    (call-with-fresh-memory-db '() (lambda ()
  (check-equal? (raw-value (thsl-src! "tests/critical-review-26-tests.tesl" 1168 (list) (lambda () (useInRange3 1 10 1)))) "1 in [1, 10]")
    ))
  )

  (test-case "T29c: at upper bound"
    (call-with-fresh-memory-db '() (lambda ()
  (check-equal? (raw-value (thsl-src! "tests/critical-review-26-tests.tesl" 1172 (list) (lambda () (useInRange3 1 10 10)))) "10 in [1, 10]")
    ))
  )

  (test-case "T29d: below lower bound fails"
    (call-with-fresh-memory-db '() (lambda ()
  (let ([tesl-ef-result (with-handlers ([exn:fail? (lambda (e) 'tesl-exception)]) (thsl-src! "tests/critical-review-26-tests.tesl" 1176 (list) (lambda ()
                          (useInRange3 1 10 0))))])
    (check-true (or (eq? tesl-ef-result 'tesl-exception) (check-fail? tesl-ef-result))
  ...
  (test-case "T29e: above upper bound fails"
    (call-with-fresh-memory-db '() (lambda ()
  (let ([tesl-ef-result (with-handlers ([exn:fail? (lambda (e) 'tesl-exception)]) (thsl-src! "tests/critical-review-26-tests.tesl" 1180 (list) (lambda ()
                          (useInRange3 1 10 11))))])
    (check-true (or (eq? tesl-ef-result 'tesl-exception) (check-fail? tesl-ef-result))
  ...
  (test-case "T29f: lo == hi, exact match"
    (call-with-fresh-memory-db '() (lambda ()
  (check-equal? (raw-value (thsl-src! "tests/critical-review-26-tests.tesl" 1184 (list) (lambda () (useInRange3 5 5 5)))) "5 in [5, 5]")
    ))
  )

  (test-case "T29g: negative range"
    (call-with-fresh-memory-db '() (lambda ()
  (define lo (thsl-src! "tests/critical-review-26-tests.tesl" 1188 (list) (lambda () (- 0 10))))
  (define hi (thsl-src! "tests/critical-review-26-tests.tesl" 1189 (list (cons 'lo lo)) (lambda () (- 0 1))))
  (define n (thsl-src! "tests/critical-review-26-tests.tesl" 1190 (list (cons 'hi hi) (cons 'lo lo)) (lambda () (- 0 5))))
  (check-equal? (raw-value (thsl-src! "tests/critical-review-26-tests.tesl" 1191 (list (cons 'n n) (cons 'hi hi) (cons 'lo lo)) (lambda () (useInRange3 lo hi n)))) "-5 in [-10, -1]")
    ))
  )

  (test-case "T30a: discard both halves, return original + 1"
    (call-with-fresh-memory-db '() (lambda ()
  (check-equal? (raw-value (thsl-src! "tests/critical-review-26-tests.tesl" 1205 (list) (lambda () (discardBothHalves 5)))) 6)
    ))
  )

  (test-case "T30b: discard both halves, n = 1"
    (call-with-fresh-memory-db '() (lambda ()
  (check-equal? (raw-value (thsl-src! "tests/critical-review-26-tests.tesl" 1209 (list) (lambda () (discardBothHalves 1)))) 2)
    ))
  )

  (test-case "T30c: check still propagates failure even with discarded binding"
    (call-with-fresh-memory-db '() (lambda ()
  (let ([tesl-ef-result (with-handlers ([exn:fail? (lambda (e) 'tesl-exception)]) (thsl-src! "tests/critical-review-26-tests.tesl" 1213 (list) (lambda ()
                          (discardBothHalves 0))))])
    (check-true (or (eq? tesl-ef-result 'tesl-exception) (check-fail? tesl-ef-result))
  ...
  (test-case "T30d: large value"
    (call-with-fresh-memory-db '() (lambda ()
  (check-equal? (raw-value (thsl-src! "tests/critical-review-26-tests.tesl" 1217 (list) (lambda () (discardBothHalves 100)))) 101)
    ))
  )
