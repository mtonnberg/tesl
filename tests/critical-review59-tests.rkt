...
(define-checker
  ...
  (thsl-src! "tests/critical-review59-tests.tesl" 46 (list (cons 'n *n)) (lambda () (if (tesl-gt? *n 0) (accept (A n) #:value *n) (reject "fail A" #:http-code 400)))))

(define-checker
  (checkB [n : Integer ::: (A n)])
  #:returns [n : Integer ::: (B n)]
  (thsl-src! "tests/critical-review59-tests.tesl" 52 (list (cons 'n *n)) (lambda () (if (tesl-lt? *n 1000) (accept (B n) #:value *n) (reject "fail B" #:http-code 400)))))
...
(define-checker
  ...
  (thsl-src! "tests/critical-review59-tests.tesl" 76 (list (cons 'n *n)) (lambda () (if (tesl-gt? *n 0) (accept (IsPositive n) #:value *n) (reject "not positive" #:http-code 400)))))

(define-checker
  (checkSmall [n : Integer])
  #:returns [n : Integer ::: (IsSmall n)]
  (thsl-src! "tests/critical-review59-tests.tesl" 82 (list (cons 'n *n)) (lambda () (if (tesl-lt? *n 100) (accept (IsSmall n) #:value *n) (reject "too large" #:http-code 400)))))
