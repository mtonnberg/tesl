...
(define/pow
  ...
  #:returns Integer
  (thsl-src! "tests/critical-review-55-tests.tesl" 76 (list (cons 'raw *raw)) (lambda () (let/check ([tesl-checked-2 (checkPos raw)]) (let ([pos tesl-checked-2]) (let ([_pair (raw-value (Tuple2 pos 0))]) (raw-value (needPos pos))))))))

(define/pow
  (r55_tu02_tuple_first_raw [raw : Integer])
  #:returns Integer
  (thsl-src! "tests/critical-review-55-tests.tesl" 81 (list (cons 'raw *raw)) (lambda () (let/check ([tesl-checked-3 (checkPos raw)]) (let ([pos tesl-checked-3]) (let ([pair (raw-value (Tuple2 pos 5))]) (+ (raw-value (tesl_import_Tuple2_first (raw-value pair))) (raw-value (tesl_import_Tuple2_second (raw-value pair))))))))))
...
(define/pow
  ...
  #:returns Integer
  (thsl-src! "tests/critical-review-55-tests.tesl" 114 (list (cons 'raw *raw)) (lambda () (let/check ([tesl-checked-6 ((check-and checkPos checkSmall) raw)]) (let ([result tesl-checked-6]) (raw-value (needBoth result)))))))
...
(define/pow
  ...
  #:returns Integer
  (thsl-src! "tests/critical-review-55-tests.tesl" 235 (list (cons 'raw *raw)) (lambda () (let ([lo 1]) (let ([hi 100]) (let/check ([tesl-checked-19 (checkInRange lo hi raw)]) (let ([v tesl-checked-19]) (raw-value (needInRange lo hi v)))))))))
...
(define/pow
  ...
  #:returns String
  (thsl-src-control! "tests/critical-review-55-tests.tesl" 274 (list (cons 't *t)) (lambda () (let ([tesl-case-21 *t]) (cond [(and (adt-value? *tesl-case-21) (eq? (adt-value-variant *tesl-case-21) 'TrafficRed)) (thsl-src! "tests/critical-review-55-tests.tesl" 275 (list) (lambda () (raw-value "stop")))] [(and (adt-value? *tesl-case-21) (eq? (adt-value-variant *tesl-case-21) 'TrafficYellow)) (thsl-src! "tests/critical-review-55-tests.tesl" 276 (list) (lambda () (raw-value "caution")))] [(and (adt-value? *tesl-case-21) (eq? (adt-value-variant *tesl-case-21) 'TrafficGreen)) (thsl-src! "tests/critical-review-55-tests.tesl" 277 (list) (lambda () (raw-value "go")))])))))

(define/pow
  (r55_mc01_literal_and_ctor [m : (Maybe Integer)])
  #:returns String
  (thsl-src-control! "tests/critical-review-55-tests.tesl" 288 (list (cons 'm *m)) (lambda () (let ([tesl-case-22 *m]) (cond [(and (adt-value? *tesl-case-22) (eq? (adt-value-variant *tesl-case-22) 'Nothing)) (thsl-src! "tests/critical-review-55-tests.tesl" 289 (list) (lambda () (raw-value "nothing")))] [(and (and (adt-value? *tesl-case-22) (eq? (adt-value-variant *tesl-case-22) 'Something)) (let ([tesl-case-22_f0 (raw-value (hash-ref (adt-value-fields *tesl-case-22) 'value))]) (= *tesl-case-22_f0 0))) (let ([tesl-case-22_f0 (raw-value (hash-ref (adt-value-fields *tesl-case-22) 'value))]) (thsl-src! "tests/critical-review-55-tests.tesl" 290 (list) (lambda () (raw-value "zero"))))] [(and (and (adt-value? *tesl-case-22) (eq? (adt-value-variant *tesl-case-22) 'Something)) (let ([tesl-case-22_f0 (raw-value (hash-ref (adt-value-fields *tesl-case-22) 'value))]) (= *tesl-case-22_f0 1))) (let ([tesl-case-22_f0 (raw-value (hash-ref (adt-value-fields *tesl-case-22) 'value))]) (thsl-src! "tests/critical-review-55-tests.tesl" 291 (list) (lambda () (raw-value "one"))))] [(and (adt-value? *tesl-case-22) (eq? (adt-value-variant *tesl-case-22) 'Something)) (thsl-src! "tests/critical-review-55-tests.tesl" 292 (list) (lambda () (raw-value "other")))])))))
...
(define/pow
  ...
  #:returns String
  (thsl-src-control! "tests/critical-review-55-tests.tesl" 300 (list (cons 's *s)) (lambda () (let ([tesl-case-23 *s]) (cond [(and (adt-value? *tesl-case-23) (eq? (adt-value-variant *tesl-case-23) 'Status2Active)) (thsl-src! "tests/critical-review-55-tests.tesl" 303 (list) (lambda () (raw-value "completed")))] [(and (adt-value? *tesl-case-23) (eq? (adt-value-variant *tesl-case-23) 'Status2Done)) (thsl-src! "tests/critical-review-55-tests.tesl" 303 (list) (lambda () (raw-value "completed")))] [(and (adt-value? *tesl-case-23) (eq? (adt-value-variant *tesl-case-23) 'Status2Cancelled)) (thsl-src! "tests/critical-review-55-tests.tesl" 305 (list) (lambda () (raw-value "cancelled")))])))))
